...
El niño se construye y anima en `src/boy.js`: carita redonda con ojos dibujados sobre su superficie, sonrisa pequeña, mejillas rosadas, pelo castaño suave y buzo azul. Las mangas y el pantalón se deforman de forma continua al doblar codos y rodillas. La carrera responde a la velocidad y el salto distingue ascenso, caída y aterrizaje. Durante las cinemáticas, cabeza y cuerpo siguen la posición 3D del punto. `node verify-boy.mjs` comprueba la superficie del rostro, la ropa, el seguimiento, la continuidad de los giros, las poses y la pausa.
