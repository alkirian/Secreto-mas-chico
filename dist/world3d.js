...
`)}var Q0={[sc]:"Linear",[rc]:"Reinhard",[ac]:"Cineon",[Cr]:"ACESFilmic",[lc]:"AgX",[cc]:"Neutral",[oc]:"Custom"};function j0(i,t){let e=Q0[t];return e===void 0?(zt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var jo=new C;function t_(){ie.getLuminanceCoefficients(jo);let i=jo.x.toFixed(4),t=jo.y.toFixed(4),e=jo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let w=y+m+a,x=y+p+o,E=Zu(s,s.VERTEX_SHADER,w),T=Zu(s,s.FRAGMENT_SHADER,x);s.attachShader(M,E),s.attachShader(M,T),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function b(U){if(i.debug.checkShaderErrors){let O=s.getProgramInfoLog(M)||"",X=s.getShaderInfoLog(E)||"",L=s.getShaderInfoLog(T)||"",z=O.trim(),$=X.trim(),K=L.trim(),st=!0,Z=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(st=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,E,T);else{let nt=$u(s,E,"vertex"),F=$u(s,T,"fragment");Xt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+nt+`
`+F)}else z!==""?zt("WebGLProgram: Program Info Log:",z):($===""||K==="")&&(Z=!1);Z&&(U.diagnostics={runnable:st,programLog:z,vertexShader:{log:$,prefix:m},fragmentShader:{log:K,prefix:p}})}s.deleteShader(E),s.deleteShader(T),g=new Cs(s,M),A=i_(s,M)}let g;this.getUniforms=function(){return g===void 0&&b(this),g};let A;this.getAttributes=function(){return A===void 0&&b(this),A};let P=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=s.getProgramParameter(M,Y0)),P},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(M),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=Z0++,this.cacheKey=t,this.usedTimes=1,this.program=M,this.vertexShader=E,this.fragmentShader=T,this}var v_=0,Fc=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,n){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Oc(t),e.set(t,n)),n}},Oc=class{constructor(t){this.id=v_++,this.code=t,this.usedTimes=0}};function y_(i){return i===Mi||i===Fr||i===Or}function M_(i,t,e,n,s,r){let a=new er,o=new Fc,l=new Set,c=[],h=new Map,f=n.logarithmicDepthBuffer,u=n.precision,d={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(g){return l.add(g),g===0?"uv":`uv${g}`}function M(g,A,P,U,O,X){let L=U.fog,z=O.geometry,$=g.isMeshStandardMaterial||g.isMeshLambertMaterial||g.isMeshPhongMaterial?U.environment:null,K=g.isMeshStandardMaterial||g.isMeshLambertMaterial&&!g.envMap||g.isMeshPhongMaterial&&!g.envMap,st=t.get(g.envMap||$,K),Z=st&&st.mapping===Pr?st.image.height:null,nt=d[g.type];g.precision!==null&&(u=n.getMaxPrecision(g.precision),u!==g.precision&&zt("WebGLProgram.getParameters:",g.precision,"not supported, using",u,"instead."));let F=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,at=F!==void 0?F.length:0,et=0;z.morphAttributes.position!==void 0&&(et=1),z.morphAttributes.normal!==void 0&&(et=2),z.morphAttributes.color!==void 0&&(et=3);let Tt,ot,wt,k;if(nt){let me=Hn[nt];Tt=me.vertexShader,ot=me.fragmentShader}else{Tt=g.vertexShader,ot=g.fragmentShader;let me=o.getVertexShaderStage(g),ae=o.getFragmentShaderStage(g);o.update(g,me,ae),wt=me.id,k=ae.id}let j=i.getRenderTarget(),_t=i.state.buffers.depth.getReversed(),Bt=O.isInstancedMesh===!0,yt=O.isBatchedMesh===!0,kt=!!g.map,ye=!!g.matcap,V=!!st,q=!!g.aoMap,ft=!!g.lightMap,pt=!!g.bumpMap&&g.wireframe===!1,Et=!!g.normalMap,Ht=!!g.displacementMap,Jt=!!g.emissiveMap,Ot=!!g.metalnessMap,Zt=!!g.roughnessMap,I=g.anisotropy>0,pe=g.clearcoat>0,Yt=g.dispersion>0,R=g.retroreflectivity>0,v=g.iridescence>0,B=g.sheen>0,H=g.transmission>0,J=I&&!!g.anisotropyMap,ct=pe&&!!g.clearcoatMap,mt=pe&&!!g.clearcoatNormalMap,tt=pe&&!!g.clearcoatRoughnessMap,it=v&&!!g.iridescenceMap,xt=v&&!!g.iridescenceThicknessMap,Nt=B&&!!g.sheenColorMap,vt=B&&!!g.sheenRoughnessMap,lt=!!g.specularMap,At=!!g.specularColorMap,Dt=!!g.specularIntensityMap,Vt=H&&!!g.transmissionMap,D=H&&!!g.thicknessMap,gt=!!g.gradientMap,Q=!!g.alphaMap,ht=g.alphaTest>0,dt=!!g.alphaHash,rt=!!g.extensions,Ut=Tn;g.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Ut=i.toneMapping);let Pt={shaderID:nt,shaderType:g.type,shaderName:g.name,vertexShader:Tt,fragmentShader:ot,defines:g.defines,customVertexShaderID:wt,customFragmentShaderID:k,isRawShaderMaterial:g.isRawShaderMaterial===!0,glslVersion:g.glslVersion,precision:u,batching:yt,batchingColor:yt&&O._colorsTexture!==null,instancing:Bt,instancingColor:Bt&&O.instanceColor!==null,instancingMorph:Bt&&O.morphTexture!==null,outputColorSpace:j===null?i.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:ie.workingColorSpace,alphaToCoverage:!!g.alphaToCoverage,map:kt,matcap:ye,envMap:V,envMapMode:V&&st.mapping,envMapCubeUVHeight:Z,aoMap:q,lightMap:ft,bumpMap:pt,normalMap:Et,displacementMap:Ht,emissiveMap:Jt,normalMapObjectSpace:Et&&g.normalMapType===_u,normalMapTangentSpace:Et&&g.normalMapType===Jo,packedNormalMap:Et&&g.normalMapType===Jo&&y_(g.normalMap.format),metalnessMap:Ot,roughnessMap:Zt,anisotropy:I,anisotropyMap:J,clearcoat:pe,clearcoatMap:ct,clearcoatNormalMap:mt,clearcoatRoughnessMap:tt,dispersion:Yt,retroreflection:R,iridescence:v,iridescenceMap:it,iridescenceThicknessMap:xt,sheen:B,sheenColorMap:Nt,sheenRoughnessMap:vt,specularMap:lt,specularColorMap:At,specularIntensityMap:Dt,transmission:H,transmissionMap:Vt,thicknessMap:D,gradientMap:gt,opaque:g.transparent===!1&&g.blending===_i&&g.alphaToCoverage===!1,alphaMap:Q,alphaTest:ht,alphaHash:dt,combine:g.combine,mapUv:kt&&_(g.map.channel),aoMapUv:q&&_(g.aoMap.channel),lightMapUv:ft&&_(g.lightMap.channel),bumpMapUv:pt&&_(g.bumpMap.channel),normalMapUv:Et&&_(g.normalMap.channel),displacementMapUv:Ht&&_(g.displacementMap.channel),emissiveMapUv:Jt&&_(g.emissiveMap.channel),metalnessMapUv:Ot&&_(g.metalnessMap.channel),roughnessMapUv:Zt&&_(g.roughnessMap.channel),anisotropyMapUv:J&&_(g.anisotropyMap.channel),clearcoatMapUv:ct&&_(g.clearcoatMap.channel),clearcoatNormalMapUv:mt&&_(g.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:tt&&_(g.clearcoatRoughnessMap.channel),iridescenceMapUv:it&&_(g.iridescenceMap.channel),iridescenceThicknessMapUv:xt&&_(g.iridescenceThicknessMap.channel),sheenColorMapUv:Nt&&_(g.sheenColorMap.channel),sheenRoughnessMapUv:vt&&_(g.sheenRoughnessMap.channel),specularMapUv:lt&&_(g.specularMap.channel),specularColorMapUv:At&&_(g.specularColorMap.channel),specularIntensityMapUv:Dt&&_(g.specularIntensityMap.channel),transmissionMapUv:Vt&&_(g.transmissionMap.channel),thicknessMapUv:D&&_(g.thicknessMap.channel),alphaMapUv:Q&&_(g.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(Et||I),vertexNormals:!!z.attributes.normal,vertexColors:g.vertexColors,vertexAlphas:g.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!z.attributes.uv&&(kt||Q),fog:!!L,useFog:g.fog===!0,fogExp2:!!L&&L.isFogExp2,flatShading:g.wireframe===!1&&(g.flatShading===!0||z.attributes.normal===void 0&&Et===!1&&(g.isMeshLambertMaterial||g.isMeshPhongMaterial||g.isMeshStandardMaterial||g.isMeshPhysicalMaterial)),sizeAttenuation:g.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:_t,skinning:O.isSkinnedMesh===!0,hasPositionAttribute:z.attributes.position!==void 0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:at,morphTextureStride:et,numSunLights:A.sun.length,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numSunLightShadows:A.sunShadowMap.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:X.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:g.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ut,decodeVideoTexture:kt&&g.map.isVideoTexture===!0&&ie.getTransfer(g.map.colorSpace)===le,decodeVideoTextureEmissive:Jt&&g.emissiveMap.isVideoTexture===!0&&ie.getTransfer(g.emissiveMap.colorSpace)===le,premultipliedAlpha:g.premultipliedAlpha,doubleSided:g.side===Ye,flipSided:g.side===qe,useDepthPacking:g.depthPacking>=0,depthPacking:g.depthPacking||0,index0AttributeName:g.index0AttributeName,extensionClipCullDistance:rt&&g.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(rt&&g.extensions.multiDraw===!0||yt)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:g.customProgramCacheKey()};return Pt.vertexUv1s=l.has(1),Pt.vertexUv2s=l.has(2),Pt.vertexUv3s=l.has(3),l.clear(),Pt}function m(g){let A=[];if(g.shaderID?A.push(g.shaderID):(A.push(g.customVertexShaderID),A.push(g.customFragmentShaderID)),g.defines!==void 0)for(let P in g.defines)A.push(P),A.push(g.defines[P]);return g.isRawShaderMaterial===!1&&(p(A,g),y(A,g),A.push(i.outputColorSpace)),A.push(g.customProgramCacheKey),A.join()}function p(g,A){g.push(A.precision),g.push(A.outputColorSpace),g.push(A.envMapMode),g.push(A.envMapCubeUVHeight),g.push(A.mapUv),g.push(A.alphaMapUv),g.push(A.lightMapUv),g.push(A.aoMapUv),g.push(A.bumpMapUv),g.push(A.normalMapUv),g.push(A.displacementMapUv),g.push(A.emissiveMapUv),g.push(A.metalnessMapUv),g.push(A.roughnessMapUv),g.push(A.anisotropyMapUv),g.push(A.clearcoatMapUv),g.push(A.clearcoatNormalMapUv),g.push(A.clearcoatRoughnessMapUv),g.push(A.iridescenceMapUv),g.push(A.iridescenceThicknessMapUv),g.push(A.sheenColorMapUv),g.push(A.sheenRoughnessMapUv),g.push(A.specularMapUv),g.push(A.specularColorMapUv),g.push(A.specularIntensityMapUv),g.push(A.transmissionMapUv),g.push(A.thicknessMapUv),g.push(A.combine),g.push(A.fogExp2),g.push(A.sizeAttenuation),g.push(A.morphTargetsCount),g.push(A.morphAttributeCount),g.push(A.numSunLights),g.push(A.numDirLights),g.push(A.numPointLights),g.push(A.numSpotLights),g.push(A.numSpotLightMaps),g.push(A.numHemiLights),g.push(A.numRectAreaLights),g.push(A.numSunLightShadows),g.push(A.numDirLightShadows),g.push(A.numPointLightShadows),g.push(A.numSpotLightShadows),g.push(A.numSpotLightShadowsWithMaps),g.push(A.numLightProbes),g.push(A.shadowMapType),g.push(A.toneMapping),g.push(A.numClippingPlanes),g.push(A.numClipIntersection),g.push(A.depthPacking)}function y(g,A){a.disableAll(),A.instancing&&a.enable(0),A.instancingColor&&a.enable(1),A.instancingMorph&&a.enable(2),A.matcap&&a.enable(3),A.envMap&&a.enable(4),A.normalMapObjectSpace&&a.enable(5),A.normalMapTangentSpace&&a.enable(6),A.clearcoat&&a.enable(7),A.iridescence&&a.enable(8),A.alphaTest&&a.enable(9),A.vertexColors&&a.enable(10),A.vertexAlphas&&a.enable(11),A.vertexUv1s&&a.enable(12),A.vertexUv2s&&a.enable(13),A.vertexUv3s&&a.enable(14),A.vertexTangents&&a.enable(15),A.anisotropy&&a.enable(16),A.alphaHash&&a.enable(17),A.batching&&a.enable(18),A.dispersion&&a.enable(19),A.retroreflection&&a.enable(24),A.batchingColor&&a.enable(20),A.gradientMap&&a.enable(21),A.packedNormalMap&&a.enable(22),A.vertexNormals&&a.enable(23),g.push(a.mask),a.disableAll(),A.fog&&a.enable(0),A.useFog&&a.enable(1),A.flatShading&&a.enable(2),A.logarithmicDepthBuffer&&a.enable(3),A.reversedDepthBuffer&&a.enable(4),A.skinning&&a.enable(5),A.morphTargets&&a.enable(6),A.morphNormals&&a.enable(7),A.morphColors&&a.enable(8),A.premultipliedAlpha&&a.enable(9),A.shadowMapEnabled&&a.enable(10),A.doubleSided&&a.enable(11),A.flipSided&&a.enable(12),A.useDepthPacking&&a.enable(13),A.dithering&&a.enable(14),A.transmission&&a.enable(15),A.sheen&&a.enable(16),A.opaque&&a.enable(17),A.pointsUvs&&a.enable(18),A.decodeVideoTexture&&a.enable(19),A.decodeVideoTextureEmissive&&a.enable(20),A.alphaToCoverage&&a.enable(21),A.numLightProbeGrids>0&&a.enable(22),A.hasPositionAttribute&&a.enable(23),g.push(a.mask)}function w(g){let A=d[g.type],P;if(A){let U=Hn[A];P=Uu.clone(U.uniforms)}else P=g.uniforms;return P}function x(g,A){let P=h.get(A);return P!==void 0?++P.usedTimes:(P=new x_(i,A,g,s),c.push(P),h.set(A,P)),P}function E(g){if(--g.usedTimes===0){let A=c.indexOf(g);c[A]=c[c.length-1],c.pop(),h.delete(g.cacheKey),g.destroy()}}function T(g){o.remove(g)}function b(){o.dispose()}return{getParameters:M,getProgramCacheKey:m,getUniforms:w,acquireProgram:x,releaseProgram:E,releaseShaderCache:T,programs:c,dispose:b}}function S_(){let i=new WeakMap;function t(a){return i.has(a)}function e(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function b_(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.materialVariant!==t.materialVariant?i.materialVariant-t.materialVariant:i.z!==t.z?i.z-t.z:i.id-t.id}function ed(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function nd(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function a(u){let d=0;return u.isInstancedMesh&&(d+=2),u.isSkinnedMesh&&(d+=1),d}function o(u,d,_,M,m,p){let y=i[t];return y===void 0?(y={id:u.id,object:u,geometry:d,material:_,materialVariant:a(u),groupOrder:M,renderOrder:u.renderOrder,z:m,group:p},i[t]=y):(y.id=u.id,y.object=u,y.geometry=d,y.material=_,y.materialVariant=a(u),y.groupOrder=M,y.renderOrder=u.renderOrder,y.z=m,y.group=p),t++,y}function l(u,d,_,M,m,p,y){y.reversedDepth===!0&&(m=-m);let w=o(u,d,_,M,m,p);_.transmission>0?n.push(w):_.transparent===!0?s.push(w):e.push(w)}function c(u,d,_,M,m,p){let y=o(u,d,_,M,m,p);_.transmission>0?n.unshift(y):_.transparent===!0?s.unshift(y):e.unshift(y)}function h(u,d){e.length>1&&e.sort(u||b_),n.length>1&&n.sort(d||ed),s.length>1&&s.sort(d||ed)}function f(){for(let u=t,d=i.length;u<d;u++){let _=i[u];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:f,sort:h}}function E_(){let i=new WeakMap;function t(n,s){let r=i.get(n),a;return r===void 0?(a=new nd,i.set(n,[a])):s>=r.length?(a=new nd,r.push(a)):a=r[s],a}function e(){i=new WeakMap}return{get:t,dispose:e}}function T_(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={direction:new C,color:new Gt};break;case"SpotLight":e={position:new C,direction:new C,color:new Gt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new C,color:new Gt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new C,skyColor:new Gt,groundColor:new Gt};break;case"RectAreaLight":e={color:new Gt,position:new C,halfWidth:new C,halfHeight:new C};break}return i[t.id]=e,e}}}function w_(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ut,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var A_=0;function R_(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function C_(i){let t=new T_,e=w_(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new C);let s=new C,r=new $t,a=new $t;function o(c){let h=0,f=0,u=0;for(let O=0;O<9;O++)n.probe[O].set(0,0,0);let d=0,_=0,M=0,m=0,p=0,y=0,w=0,x=0,E=0,T=0,b=0,g=0,A=0,P=0;c.sort(R_);for(let O=0,X=c.length;O<X;O++){let L=c[O],z=L.color,$=L.intensity,K=L.distance,st=null;if(L.shadow&&L.shadow.map&&(L.shadow.map.texture.format===Mi?st=L.shadow.map.texture:st=L.shadow.map.depthTexture||L.shadow.map.texture),L.isAmbientLight)h+=z.r*$,f+=z.g*$,u+=z.b*$;else if(L.isLightProbe){for(let Z=0;Z<9;Z++)n.probe[Z].addScaledVector(L.sh.coefficients[Z],$);P++}else if(L.isSunLight){let Z=t.get(L);if(Z.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){let nt=L.shadow,F=e.get(L);F.shadowIntensity=nt.intensity,F.shadowBias=nt.bias,F.shadowNormalBias=nt.normalBias,F.shadowRadius=nt.radius,F.shadowMapSize.copy(nt.mapSize).multiply(nt.getFrameExtents()),n.sunShadow[_]=F,n.sunShadowMap[_]=st;let at=nt.getViewportCount();for(let et=0;et<at;et++)n.sunShadowMatrix[M+et]=nt.getMatrix(et),n.sunShadowCascade[M+et]=nt._cascadeData[et];M+=at,_++}n.sun[d]=Z,d++}else if(L.isDirectionalLight){let Z=t.get(L);if(Z.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){let nt=L.shadow,F=e.get(L);F.shadowIntensity=nt.intensity,F.shadowBias=nt.bias,F.shadowNormalBias=nt.normalBias,F.shadowRadius=nt.radius,F.shadowMapSize=nt.mapSize,n.directionalShadow[m]=F,n.directionalShadowMap[m]=st,n.directionalShadowMatrix[m]=L.shadow.matrix,E++}n.directional[m]=Z,m++}else if(L.isSpotLight){let Z=t.get(L);Z.position.setFromMatrixPosition(L.matrixWorld),Z.color.copy(z).multiplyScalar($),Z.distance=K,Z.coneCos=Math.cos(L.angle),Z.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),Z.decay=L.decay,n.spot[y]=Z;let nt=L.shadow;if(L.map&&(n.spotLightMap[g]=L.map,g++,nt.updateMatrices(L),L.castShadow&&A++),n.spotLightMatrix[y]=nt.matrix,L.castShadow){let F=e.get(L);F.shadowIntensity=nt.intensity,F.shadowBias=nt.bias,F.shadowNormalBias=nt.normalBias,F.shadowRadius=nt.radius,F.shadowMapSize=nt.mapSize,n.spotShadow[y]=F,n.spotShadowMap[y]=st,b++}y++}else if(L.isRectAreaLight){let Z=t.get(L);Z.color.copy(z).multiplyScalar($),Z.halfWidth.set(L.width*.5,0,0),Z.halfHeight.set(0,L.height*.5,0),n.rectArea[w]=Z,w++}else if(L.isPointLight){let Z=t.get(L);if(Z.color.copy(L.color).multiplyScalar(L.intensity),Z.distance=L.distance,Z.decay=L.decay,L.castShadow){let nt=L.shadow,F=e.get(L);F.shadowIntensity=nt.intensity,F.shadowBias=nt.bias,F.shadowNormalBias=nt.normalBias,F.shadowRadius=nt.radius,F.shadowMapSize=nt.mapSize,F.shadowCameraNear=nt.camera.near,F.shadowCameraFar=nt.camera.far,n.pointShadow[p]=F,n.pointShadowMap[p]=st,n.pointShadowMatrix[p]=L.shadow.matrix,T++}n.point[p]=Z,p++}else if(L.isHemisphereLight){let Z=t.get(L);Z.skyColor.copy(L.color).multiplyScalar($),Z.groundColor.copy(L.groundColor).multiplyScalar($),n.hemi[x]=Z,x++}}w>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Mt.LTC_FLOAT_1,n.rectAreaLTC2=Mt.LTC_FLOAT_2):(n.rectAreaLTC1=Mt.LTC_HALF_1,n.rectAreaLTC2=Mt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=f,n.ambient[2]=u;let U=n.hash;(U.sunLength!==d||U.directionalLength!==m||U.pointLength!==p||U.spotLength!==y||U.rectAreaLength!==w||U.hemiLength!==x||U.numSunShadows!==_||U.numDirectionalShadows!==E||U.numPointShadows!==T||U.numSpotShadows!==b||U.numSpotMaps!==g||U.numLightProbes!==P)&&(n.sun.length=d,n.directional.length=m,n.spot.length=y,n.rectArea.length=w,n.point.length=p,n.hemi.length=x,n.sunShadow.length=_,n.sunShadowMap.length=_,n.sunShadowMatrix.length=M,n.sunShadowCascade.length=M,n.directionalShadow.length=E,n.directionalShadowMap.length=E,n.directionalShadowMatrix.length=E,n.pointShadow.length=T,n.pointShadowMap.length=T,n.pointShadowMatrix.length=T,n.spotShadow.length=b,n.spotShadowMap.length=b,n.spotLightMatrix.length=b+g-A,n.spotLightMap.length=g,n.numSpotLightShadowsWithMaps=A,n.numLightProbes=P,U.sunLength=d,U.directionalLength=m,U.pointLength=p,U.spotLength=y,U.rectAreaLength=w,U.hemiLength=x,U.numSunShadows=_,U.numDirectionalShadows=E,U.numPointShadows=T,U.numSpotShadows=b,U.numSpotMaps=g,U.numLightProbes=P,n.version=A_++)}function l(c,h){let f=0,u=0,d=0,_=0,M=0,m=0,p=h.matrixWorldInverse;for(let y=0,w=c.length;y<w;y++){let x=c[y];if(x.isSunLight){let E=n.sun[f];E.direction.setFromMatrixPosition(x.matrixWorld),E.direction.transformDirection(p),f++}else if(x.isDirectionalLight){let E=n.directional[u];E.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(p),u++}else if(x.isSpotLight){let E=n.spot[_];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),E.direction.setFromMatrixPosition(x.matrixWorld),s.setFromMatrixPosition(x.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(p),_++}else if(x.isRectAreaLight){let E=n.rectArea[M];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),a.identity(),r.copy(x.matrixWorld),r.premultiply(p),a.extractRotation(r),E.halfWidth.set(x.width*.5,0,0),E.halfHeight.set(0,x.height*.5,0),E.halfWidth.applyMatrix4(a),E.halfHeight.applyMatrix4(a),M++}else if(x.isPointLight){let E=n.point[d];E.position.setFromMatrixPosition(x.matrixWorld),E.position.applyMatrix4(p),d++}else if(x.isHemisphereLight){let E=n.hemi[m];E.direction.setFromMatrixPosition(x.matrixWorld),E.direction.transformDirection(p),m++}}}return{setup:o,setupView:l,state:n}}function id(i){let t=new C_(i),e=[],n=[],s=[];function r(u){f.camera=u,e.length=0,n.length=0,s.length=0}function a(u){e.push(u)}function o(u){n.push(u)}function l(u){s.push(u)}function c(){t.setup(e)}function h(u){t.setupView(e,u)}let f={lightsArray:e,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:f,setupLights:c,setupLightsView:h,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function P_(i){let t=new WeakMap;function e(s,r=0){let a=t.get(s),o;return a===void 0?(o=new id(i),t.set(s,[o])):r>=a.length?(o=new id(i),a.push(o)):o=a[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}var I_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,D_=[new C(1,0,0),new C(-1,0,0),new C(0,1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1)],N_=[new C(0,-1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1),new C(0,-1,0),new C(0,-1,0)],sd=new $t,zr=new C,Pc=new C;function U_(i,t,e){let n=new _s,s=new ut,r=new ut,a=new he,o=new Za,l=new Ja,c={},h=e.maxTextureSize,f={[gi]:qe,[qe]:gi,[Ye]:Ye},u=new He({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ut},radius:{value:4}},vertexShader:I_,fragmentShader:L_}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let _=new ne;_.setAttribute("position",new de(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let M=new se(_,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ni;let p=this.type;this.render=function(T,b,g){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===Yh&&(zt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Ni);let A=i.getRenderTarget(),P=i.getActiveCubeFace(),U=i.getActiveMipmapLevel(),O=i.state;O.setBlending(Bn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let X=p!==this.type;X&&b.traverse(function(L){L.material&&(Array.isArray(L.material)?L.material.forEach(z=>z.needsUpdate=!0):L.material.needsUpdate=!0)});for(let L=0,z=T.length;L<z;L++){let $=T[L],K=$.shadow;if(K===void 0){zt("WebGLShadowMap:",$,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;s.copy(K.mapSize);let st=K.getFrameExtents();s.multiply(st),r.copy(K.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/st.x),s.x=r.x*st.x,K.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/st.y),s.y=r.y*st.y,K.mapSize.y=r.y));let Z=i.state.buffers.depth.getReversed();if(K.camera._reversedDepth=Z,K.map===null||X===!0){if(K.map!==null&&(K.map.depthTexture!==null&&(K.map.depthTexture.dispose(),K.map.depthTexture=null),K.map.dispose()),this.type===Es){if($.isPointLight){zt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}K.map=new Ze(s.x,s.y,{format:Mi,type:An,minFilter:Ue,magFilter:Ue,generateMipmaps:!1}),K.map.texture.name=$.name+".shadowMap",K.map.depthTexture=new ci(s.x,s.y,nn),K.map.depthTexture.name=$.name+".shadowMapDepth",K.map.depthTexture.format=Dn,K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=Ne,K.map.depthTexture.magFilter=Ne}else $.isPointLight?(K.map=new el(s.x),K.map.depthTexture=new Va(s.x,wn)):(K.map=new Ze(s.x,s.y),K.map.depthTexture=new ci(s.x,s.y,wn)),K.map.depthTexture.name=$.name+".shadowMap",K.map.depthTexture.format=Dn,this.type===Ni?(K.map.depthTexture.compareFunction=Z?Ko:$o,K.map.depthTexture.minFilter=Ue,K.map.depthTexture.magFilter=Ue):(K.map.depthTexture.compareFunction=null,K.map.depthTexture.minFilter=Ne,K.map.depthTexture.magFilter=Ne);K.camera.updateProjectionMatrix()}K.map.isWebGLCubeRenderTarget!==!0&&(K.map.width!==s.x||K.map.height!==s.y)&&K.map.setSize(s.x,s.y);let nt=K.map.isWebGLCubeRenderTarget?6:K.getViewportCount();$.isPointLight!==!0&&K.updateMatrices($,g);for(let F=0;F<nt;F++){let at=K.getCamera(F);if($.isPointLight){let et=K.camera,Tt=K.matrix,ot=$.distance||et.far;ot!==et.far&&(et.far=ot,et.updateProjectionMatrix()),zr.setFromMatrixPosition($.matrixWorld),et.position.copy(zr),Pc.copy(et.position),Pc.add(D_[F]),et.up.copy(N_[F]),et.lookAt(Pc),et.updateMatrixWorld(),Tt.makeTranslation(-zr.x,-zr.y,-zr.z),sd.multiplyMatrices(et.projectionMatrix,et.matrixWorldInverse),K._frustum.setFromProjectionMatrix(sd,et.coordinateSystem,et.reversedDepth)}if(K.map.isWebGLCubeRenderTarget)i.setRenderTarget(K.map,F),i.clear();else{F===0&&(i.setRenderTarget(K.map),i.clear());let et=K.getViewport(F);a.set(r.x*et.x,r.y*et.y,r.x*et.z,r.y*et.w),O.viewport(a)}n=K.getFrustum(F),x(b,g,at,$,this.type)}K.isPointLightShadow!==!0&&this.type===Es&&y(K,g),K.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(A,P,U)};function y(T,b){let g=t.update(M);u.defines.VSM_SAMPLES!==T.blurSamples&&(u.defines.VSM_SAMPLES=T.blurSamples,d.defines.VSM_SAMPLES=T.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),T.mapPass===null?T.mapPass=new Ze(s.x,s.y,{format:Mi,type:An}):(T.mapPass.width!==T.map.width||T.mapPass.height!==T.map.height)&&T.mapPass.setSize(T.map.width,T.map.height),u.uniforms.shadow_pass.value=T.map.depthTexture,u.uniforms.resolution.value.set(T.map.width,T.map.height),u.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(b,null,g,u,M,null),d.uniforms.shadow_pass.value=T.mapPass.texture,d.uniforms.resolution.value.set(T.map.width,T.map.height),d.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(b,null,g,d,M,null)}function w(T,b,g,A){let P=null,U=g.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(U!==void 0)P=U;else if(P=g.isPointLight===!0?l:o,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0||b.alphaToCoverage===!0){let O=P.uuid,X=b.uuid,L=c[O];L===void 0&&(L={},c[O]=L);let z=L[X];z===void 0&&(z=P.clone(),L[X]=z,b.addEventListener("dispose",E)),P=z}if(P.visible=b.visible,P.wireframe=b.wireframe,A===Es?P.side=b.shadowSide!==null?b.shadowSide:b.side:P.side=b.shadowSide!==null?b.shadowSide:f[b.side],P.alphaMap=b.alphaMap,P.alphaTest=b.alphaToCoverage===!0?.5:b.alphaTest,P.map=b.map,P.clipShadows=b.clipShadows,P.clippingPlanes=b.clippingPlanes,P.clipIntersection=b.clipIntersection,P.displacementMap=b.displacementMap,P.displacementScale=b.displacementScale,P.displacementBias=b.displacementBias,P.wireframeLinewidth=b.wireframeLinewidth,P.linewidth=b.linewidth,g.isPointLight===!0&&P.isMeshDistanceMaterial===!0){let O=i.properties.get(P);O.light=g}return P}function x(T,b,g,A,P){if(T.visible===!1)return;if(T.layers.test(b.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===Es)&&(!T.frustumCulled||T.intersectsFrustum(n))){T.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,T.matrixWorld);let X=t.update(T),L=T.material;if(Array.isArray(L)){let z=X.groups;for(let $=0,K=z.length;$<K;$++){let st=z[$],Z=L[st.materialIndex];if(Z&&Z.visible){let nt=w(T,Z,A,P);T.onBeforeShadow(i,T,b,g,X,nt,st),i.renderBufferDirect(g,null,X,nt,T,st),T.onAfterShadow(i,T,b,g,X,nt,st)}}}else if(L.visible){let z=w(T,L,A,P);T.onBeforeShadow(i,T,b,g,X,z,null),i.renderBufferDirect(g,null,X,z,T,null),T.onAfterShadow(i,T,b,g,X,z,null)}}let O=T.children;for(let X=0,L=O.length;X<L;X++)x(O[X],b,g,A,P)}function E(T){T.target.removeEventListener("dispose",E);for(let g in c){let A=c[g],P=T.target.uuid;P in A&&(A[P].dispose(),delete A[P])}}}function F_(i,t){function e(){let D=!1,gt=new he,Q=null,ht=new he(0,0,0,0);return{setMask:function(dt){Q!==dt&&!D&&(i.colorMask(dt,dt,dt,dt),Q=dt)},setLocked:function(dt){D=dt},setClear:function(dt,rt,Ut,Pt,me){me===!0&&(dt*=Pt,rt*=Pt,Ut*=Pt),gt.set(dt,rt,Ut,Pt),ht.equals(gt)===!1&&(i.clearColor(dt,rt,Ut,Pt),ht.copy(gt))},reset:function(){D=!1,Q=null,ht.set(-1,0,0,0)}}}function n(){let D=!1,gt=!1,Q=null,ht=null,dt=null;return{setReversed:function(rt){if(gt!==rt){let Ut=t.get("EXT_clip_control");rt?Ut.clipControlEXT(Ut.LOWER_LEFT_EXT,Ut.ZERO_TO_ONE_EXT):Ut.clipControlEXT(Ut.LOWER_LEFT_EXT,Ut.NEGATIVE_ONE_TO_ONE_EXT),gt=rt;let Pt=dt;dt=null,this.setClear(Pt)}},getReversed:function(){return gt},setTest:function(rt){rt?j(i.DEPTH_TEST):_t(i.DEPTH_TEST)},setMask:function(rt){Q!==rt&&!D&&(i.depthMask(rt),Q=rt)},setFunc:function(rt){if(gt&&(rt=Ru[rt]),ht!==rt){switch(rt){case Ea:i.depthFunc(i.NEVER);break;case Ta:i.depthFunc(i.ALWAYS);break;case wa:i.depthFunc(i.LESS);break;case ls:i.depthFunc(i.LEQUAL);break;case Aa:i.depthFunc(i.EQUAL);break;case Ra:i.depthFunc(i.GEQUAL);break;case Ca:i.depthFunc(i.GREATER);break;case Pa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ht=rt}},setLocked:function(rt){D=rt},setClear:function(rt){dt!==rt&&(dt=rt,gt&&(rt=1-rt),i.clearDepth(rt))},reset:function(){D=!1,Q=null,ht=null,dt=null,gt=!1}}}function s(){let D=!1,gt=null,Q=null,ht=null,dt=null,rt=null,Ut=null,Pt=null,me=null;return{setTest:function(ae){D||(ae?j(i.STENCIL_TEST):_t(i.STENCIL_TEST))},setMask:function(ae){gt!==ae&&!D&&(i.stencilMask(ae),gt=ae)},setFunc:function(ae,dn,Cn){(Q!==ae||ht!==dn||dt!==Cn)&&(i.stencilFunc(ae,dn,Cn),Q=ae,ht=dn,dt=Cn)},setOp:function(ae,dn,Cn){(rt!==ae||Ut!==dn||Pt!==Cn)&&(i.stencilOp(ae,dn,Cn),rt=ae,Ut=dn,Pt=Cn)},setLocked:function(ae){D=ae},setClear:function(ae){me!==ae&&(i.clearStencil(ae),me=ae)},reset:function(){D=!1,gt=null,Q=null,ht=null,dt=null,rt=null,Ut=null,Pt=null,me=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,h={},f={},u={},d=new WeakMap,_=[],M=null,m=!1,p=null,y=null,w=null,x=null,E=null,T=null,b=null,g=new Gt(0,0,0),A=0,P=!1,U=null,O=null,X=null,L=null,z=null,$=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),K=!1,st=0,Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(st=parseFloat(/^WebGL (\d)/.exec(Z)[1]),K=st>=1):Z.indexOf("OpenGL ES")!==-1&&(st=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),K=st>=2);let nt=null,F={},at=i.getParameter(i.SCISSOR_BOX),et=i.getParameter(i.VIEWPORT),Tt=new he().fromArray(at),ot=new he().fromArray(et);function wt(D,gt,Q,ht){let dt=new Uint8Array(4),rt=i.createTexture();i.bindTexture(D,rt),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ut=0;Ut<Q;Ut++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(gt,0,i.RGBA,1,1,ht,0,i.RGBA,i.UNSIGNED_BYTE,dt):i.texImage2D(gt+Ut,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,dt);return rt}let k={};k[i.TEXTURE_2D]=wt(i.TEXTURE_2D,i.TEXTURE_2D,1),k[i.TEXTURE_CUBE_MAP]=wt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),k[i.TEXTURE_2D_ARRAY]=wt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),k[i.TEXTURE_3D]=wt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(i.DEPTH_TEST),a.setFunc(ls),pt(!1),Et(Ql),j(i.CULL_FACE),q(Bn);function j(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function _t(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function Bt(D,gt){return u[D]!==gt?(i.bindFramebuffer(D,gt),u[D]=gt,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=gt),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=gt),!0):!1}function yt(D,gt){let Q=_,ht=!1;if(D){Q=d.get(gt),Q===void 0&&(Q=[],d.set(gt,Q));let dt=D.textures;if(Q.length!==dt.length||Q[0]!==i.COLOR_ATTACHMENT0){for(let rt=0,Ut=dt.length;rt<Ut;rt++)Q[rt]=i.COLOR_ATTACHMENT0+rt;Q.length=dt.length,ht=!0}}else Q[0]!==i.BACK&&(Q[0]=i.BACK,ht=!0);ht&&i.drawBuffers(Q)}function kt(D){return M!==D?(i.useProgram(D),M=D,!0):!1}let ye={[Ui]:i.FUNC_ADD,[Jh]:i.FUNC_SUBTRACT,[$h]:i.FUNC_REVERSE_SUBTRACT};ye[Kh]=i.MIN,ye[Qh]=i.MAX;let V={[jh]:i.ZERO,[tu]:i.ONE,[eu]:i.SRC_COLOR,[ec]:i.SRC_ALPHA,[ou]:i.SRC_ALPHA_SATURATE,[ru]:i.DST_COLOR,[iu]:i.DST_ALPHA,[nu]:i.ONE_MINUS_SRC_COLOR,[nc]:i.ONE_MINUS_SRC_ALPHA,[au]:i.ONE_MINUS_DST_COLOR,[su]:i.ONE_MINUS_DST_ALPHA,[lu]:i.CONSTANT_COLOR,[cu]:i.ONE_MINUS_CONSTANT_COLOR,[hu]:i.CONSTANT_ALPHA,[uu]:i.ONE_MINUS_CONSTANT_ALPHA};function q(D,gt,Q,ht,dt,rt,Ut,Pt,me,ae){if(D===Bn){m===!0&&(_t(i.BLEND),m=!1);return}if(m===!1&&(j(i.BLEND),m=!0),D!==Zh){if(D!==p||ae!==P){if((y!==Ui||E!==Ui)&&(i.blendEquation(i.FUNC_ADD),y=Ui,E=Ui),ae)switch(D){case _i:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case hn:i.blendFunc(i.ONE,i.ONE);break;case jl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case tc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Xt("WebGLState: Invalid blending: ",D);break}else switch(D){case _i:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case hn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case jl:Xt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case tc:Xt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xt("WebGLState: Invalid blending: ",D);break}w=null,x=null,T=null,b=null,g.set(0,0,0),A=0,p=D,P=ae}return}dt=dt||gt,rt=rt||Q,Ut=Ut||ht,(gt!==y||dt!==E)&&(i.blendEquationSeparate(ye[gt],ye[dt]),y=gt,E=dt),(Q!==w||ht!==x||rt!==T||Ut!==b)&&(i.blendFuncSeparate(V[Q],V[ht],V[rt],V[Ut]),w=Q,x=ht,T=rt,b=Ut),(Pt.equals(g)===!1||me!==A)&&(i.blendColor(Pt.r,Pt.g,Pt.b,me),g.copy(Pt),A=me),p=D,P=!1}function ft(D,gt){D.side===Ye?_t(i.CULL_FACE):j(i.CULL_FACE);let Q=D.side===qe;gt&&(Q=!Q),pt(Q),D.blending===_i&&D.transparent===!1?q(Bn):q(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);let ht=D.stencilWrite;o.setTest(ht),ht&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),Jt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):_t(i.SAMPLE_ALPHA_TO_COVERAGE)}function pt(D){U!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),U=D)}function Et(D){D!==Xh?(j(i.CULL_FACE),D!==O&&(D===Ql?i.cullFace(i.BACK):D===qh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):_t(i.CULL_FACE),O=D}function Ht(D){D!==X&&(K&&i.lineWidth(D),X=D)}function Jt(D,gt,Q){D?(j(i.POLYGON_OFFSET_FILL),(L!==gt||z!==Q)&&(L=gt,z=Q,a.getReversed()&&(gt=-gt),i.polygonOffset(gt,Q))):_t(i.POLYGON_OFFSET_FILL)}function Ot(D){D?j(i.SCISSOR_TEST):_t(i.SCISSOR_TEST)}function Zt(D){D===void 0&&(D=i.TEXTURE0+$-1),nt!==D&&(i.activeTexture(D),nt=D)}function I(D,gt,Q){Q===void 0&&(nt===null?Q=i.TEXTURE0+$-1:Q=nt);let ht=F[Q];ht===void 0&&(ht={type:void 0,texture:void 0},F[Q]=ht),(ht.type!==D||ht.texture!==gt)&&(nt!==Q&&(i.activeTexture(Q),nt=Q),i.bindTexture(D,gt||k[D]),ht.type=D,ht.texture=gt)}function pe(){let D=F[nt];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Yt(){try{i.compressedTexImage2D(...arguments)}catch(D){Xt("WebGLState:",D)}}function R(){try{i.compressedTexImage3D(...arguments)}catch(D){Xt("WebGLState:",D)}}function v(){try{i.texSubImage2D(...arguments)}catch(D){Xt("WebGLState:",D)}}function B(){try{i.texSubImage3D(...arguments)}catch(D){Xt("WebGLState:",D)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Xt("WebGLState:",D)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Xt("WebGLState:",D)}}function ct(){try{i.texStorage2D(...arguments)}catch(D){Xt("WebGLState:",D)}}function mt(){try{i.texStorage3D(...arguments)}catch(D){Xt("WebGLState:",D)}}function tt(){try{i.texImage2D(...arguments)}catch(D){Xt("WebGLState:",D)}}function it(){try{i.texImage3D(...arguments)}catch(D){Xt("WebGLState:",D)}}function xt(D){return f[D]!==void 0?f[D]:i.getParameter(D)}function Nt(D,gt){f[D]!==gt&&(i.pixelStorei(D,gt),f[D]=gt)}function vt(D){Tt.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Tt.copy(D))}function lt(D){ot.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),ot.copy(D))}function At(D,gt){let Q=c.get(gt);Q===void 0&&(Q=new WeakMap,c.set(gt,Q));let ht=Q.get(D);ht===void 0&&(ht=i.getUniformBlockIndex(gt,D.name),Q.set(D,ht))}function Dt(D,gt){let ht=c.get(gt).get(D);l.get(gt)!==ht&&(i.uniformBlockBinding(gt,ht,D.__bindingPointIndex),l.set(gt,ht))}function Vt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},f={},nt=null,F={},u={},d=new WeakMap,_=[],M=null,m=!1,p=null,y=null,w=null,x=null,E=null,T=null,b=null,g=new Gt(0,0,0),A=0,P=!1,U=null,O=null,X=null,L=null,z=null,Tt.set(0,0,i.canvas.width,i.canvas.height),ot.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:_t,bindFramebuffer:Bt,drawBuffers:yt,useProgram:kt,setBlending:q,setMaterial:ft,setFlipSided:pt,setCullFace:Et,setLineWidth:Ht,setPolygonOffset:Jt,setScissorTest:Ot,activeTexture:Zt,bindTexture:I,unbindTexture:pe,compressedTexImage2D:Yt,compressedTexImage3D:R,texImage2D:tt,texImage3D:it,pixelStorei:Nt,getParameter:xt,updateUBOMapping:At,uniformBlockBinding:Dt,texStorage2D:ct,texStorage3D:mt,texSubImage2D:v,texSubImage3D:B,compressedTexSubImage2D:H,compressedTexSubImage3D:J,scissor:vt,viewport:lt,reset:Vt}}function O_(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ut,h=new WeakMap,f=new Set,u,d=new WeakMap,_=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(R,v){return _?new OffscreenCanvas(R,v):Qs("canvas")}function m(R,v,B){let H=1,J=Yt(R);if((J.width>B||J.height>B)&&(H=B/Math.max(J.width,J.height)),H<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let ct=Math.floor(H*J.width),mt=Math.floor(H*J.height);u===void 0&&(u=M(ct,mt));let tt=v?M(ct,mt):u;return tt.width=ct,tt.height=mt,tt.getContext("2d").drawImage(R,0,0,ct,mt),zt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ct+"x"+mt+")."),tt}else return"data"in R&&zt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),R;return R}function p(R){return R.generateMipmaps}function y(R){i.generateMipmap(R)}function w(R){return R.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?i.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(R,v,B,H,J,ct=!1){if(R!==null){if(i[R]!==void 0)return i[R];zt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let mt;H&&(mt=t.get("EXT_texture_norm16"),mt||zt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let tt=v;if(v===i.RED&&(B===i.FLOAT&&(tt=i.R32F),B===i.HALF_FLOAT&&(tt=i.R16F),B===i.UNSIGNED_BYTE&&(tt=i.R8),B===i.UNSIGNED_SHORT&&mt&&(tt=mt.R16_EXT),B===i.SHORT&&mt&&(tt=mt.R16_SNORM_EXT)),v===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(tt=i.R8UI),B===i.UNSIGNED_SHORT&&(tt=i.R16UI),B===i.UNSIGNED_INT&&(tt=i.R32UI),B===i.BYTE&&(tt=i.R8I),B===i.SHORT&&(tt=i.R16I),B===i.INT&&(tt=i.R32I)),v===i.RG&&(B===i.FLOAT&&(tt=i.RG32F),B===i.HALF_FLOAT&&(tt=i.RG16F),B===i.UNSIGNED_BYTE&&(tt=i.RG8),B===i.UNSIGNED_SHORT&&mt&&(tt=mt.RG16_EXT),B===i.SHORT&&mt&&(tt=mt.RG16_SNORM_EXT)),v===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(tt=i.RG8UI),B===i.UNSIGNED_SHORT&&(tt=i.RG16UI),B===i.UNSIGNED_INT&&(tt=i.RG32UI),B===i.BYTE&&(tt=i.RG8I),B===i.SHORT&&(tt=i.RG16I),B===i.INT&&(tt=i.RG32I)),v===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(tt=i.RGB8UI),B===i.UNSIGNED_SHORT&&(tt=i.RGB16UI),B===i.UNSIGNED_INT&&(tt=i.RGB32UI),B===i.BYTE&&(tt=i.RGB8I),B===i.SHORT&&(tt=i.RGB16I),B===i.INT&&(tt=i.RGB32I)),v===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(tt=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(tt=i.RGBA16UI),B===i.UNSIGNED_INT&&(tt=i.RGBA32UI),B===i.BYTE&&(tt=i.RGBA8I),B===i.SHORT&&(tt=i.RGBA16I),B===i.INT&&(tt=i.RGBA32I)),v===i.RGB&&(B===i.UNSIGNED_SHORT&&mt&&(tt=mt.RGB16_EXT),B===i.SHORT&&mt&&(tt=mt.RGB16_SNORM_EXT),B===i.UNSIGNED_INT_5_9_9_9_REV&&(tt=i.RGB9_E5),B===i.UNSIGNED_INT_10F_11F_11F_REV&&(tt=i.R11F_G11F_B10F)),v===i.RGBA){let it=ct?Ks:ie.getTransfer(J);B===i.FLOAT&&(tt=i.RGBA32F),B===i.HALF_FLOAT&&(tt=i.RGBA16F),B===i.UNSIGNED_BYTE&&(tt=it===le?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT&&mt&&(tt=mt.RGBA16_EXT),B===i.SHORT&&mt&&(tt=mt.RGBA16_SNORM_EXT),B===i.UNSIGNED_SHORT_4_4_4_4&&(tt=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(tt=i.RGB5_A1)}return(tt===i.R16F||tt===i.R32F||tt===i.RG16F||tt===i.RG32F||tt===i.RGBA16F||tt===i.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function E(R,v){let B;return R?v===null||v===wn||v===ws?B=i.DEPTH24_STENCIL8:v===nn?B=i.DEPTH32F_STENCIL8:v===Ts&&(B=i.DEPTH24_STENCIL8,zt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===wn||v===ws?B=i.DEPTH_COMPONENT24:v===nn?B=i.DEPTH_COMPONENT32F:v===Ts&&(B=i.DEPTH_COMPONENT16),B}function T(R,v){return p(R)===!0||R.isFramebufferTexture&&R.minFilter!==Ne&&R.minFilter!==Ue?Math.log2(Math.max(v.width,v.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?v.mipmaps.length:1}function b(R){let v=R.target;v.removeEventListener("dispose",b),A(v),v.isVideoTexture&&h.delete(v),v.isHTMLTexture&&f.delete(v)}function g(R){let v=R.target;v.removeEventListener("dispose",g),U(v)}function A(R){let v=n.get(R);if(v.__webglInit===void 0)return;let B=R.source,H=d.get(B);if(H){let J=H[v.__cacheKey];J.usedTimes--,J.usedTimes===0&&P(R),Object.keys(H).length===0&&d.delete(B)}n.remove(R)}function P(R){let v=n.get(R);i.deleteTexture(v.__webglTexture);let B=R.source,H=d.get(B);delete H[v.__cacheKey],a.memory.textures--}function U(R){let v=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(v.__webglFramebuffer[H]))for(let J=0;J<v.__webglFramebuffer[H].length;J++)i.deleteFramebuffer(v.__webglFramebuffer[H][J]);else i.deleteFramebuffer(v.__webglFramebuffer[H]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[H])}else{if(Array.isArray(v.__webglFramebuffer))for(let H=0;H<v.__webglFramebuffer.length;H++)i.deleteFramebuffer(v.__webglFramebuffer[H]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let H=0;H<v.__webglColorRenderbuffer.length;H++)v.__webglColorRenderbuffer[H]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[H]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let B=R.textures;for(let H=0,J=B.length;H<J;H++){let ct=n.get(B[H]);ct.__webglTexture&&(i.deleteTexture(ct.__webglTexture),a.memory.textures--),n.remove(B[H])}n.remove(R)}let O=0;function X(){O=0}function L(){return O}function z(R){O=R}function $(){let R=O;return R>=s.maxTextures&&zt("WebGLTextures: Trying to use "+(R+1)+" texture units while this GPU supports only "+s.maxTextures),O+=1,R}function K(R){let v=[];return v.push(R.wrapS),v.push(R.wrapT),v.push(R.wrapR||0),v.push(R.magFilter),v.push(R.minFilter),v.push(R.anisotropy),v.push(R.internalFormat),v.push(R.format),v.push(R.type),v.push(R.generateMipmaps),v.push(R.premultiplyAlpha),v.push(R.flipY),v.push(R.unpackAlignment),v.push(R.colorSpace),v.join()}function st(R,v){let B=n.get(R);if(R.isVideoTexture&&I(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&B.__version!==R.version){let H=R.image;if(H===null)zt("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)zt("WebGLRenderer: Texture marked for update but image is incomplete");else{_t(B,R,v);return}}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+v)}function Z(R,v){let B=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){_t(B,R,v);return}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+v)}function nt(R,v){let B=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){_t(B,R,v);return}e.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+v)}function F(R,v){let B=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&B.__version!==R.version){Bt(B,R,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+v)}let at={[Ia]:i.REPEAT,[Ln]:i.CLAMP_TO_EDGE,[La]:i.MIRRORED_REPEAT},et={[Ne]:i.NEAREST,[mu]:i.NEAREST_MIPMAP_NEAREST,[Ir]:i.NEAREST_MIPMAP_LINEAR,[Ue]:i.LINEAR,[ho]:i.LINEAR_MIPMAP_NEAREST,[vi]:i.LINEAR_MIPMAP_LINEAR},Tt={[vu]:i.NEVER,[Eu]:i.ALWAYS,[yu]:i.LESS,[$o]:i.LEQUAL,[Mu]:i.EQUAL,[Ko]:i.GEQUAL,[Su]:i.GREATER,[bu]:i.NOTEQUAL};function ot(R,v){if(v.type===nn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Ue||v.magFilter===ho||v.magFilter===Ir||v.magFilter===vi||v.minFilter===Ue||v.minFilter===ho||v.minFilter===Ir||v.minFilter===vi)&&zt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(R,i.TEXTURE_WRAP_S,at[v.wrapS]),i.texParameteri(R,i.TEXTURE_WRAP_T,at[v.wrapT]),(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)&&i.texParameteri(R,i.TEXTURE_WRAP_R,at[v.wrapR]),i.texParameteri(R,i.TEXTURE_MAG_FILTER,et[v.magFilter]),i.texParameteri(R,i.TEXTURE_MIN_FILTER,et[v.minFilter]),v.compareFunction&&(i.texParameteri(R,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(R,i.TEXTURE_COMPARE_FUNC,Tt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ne||v.minFilter!==Ir&&v.minFilter!==vi||v.type===nn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){let B=t.get("EXT_texture_filter_anisotropic");i.texParameterf(R,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function wt(R,v){let B=!1;R.__webglInit===void 0&&(R.__webglInit=!0,v.addEventListener("dispose",b));let H=v.source,J=d.get(H);J===void 0&&(J={},d.set(H,J));let ct=K(v);if(ct!==R.__cacheKey){J[ct]===void 0&&(J[ct]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),J[ct].usedTimes++;let mt=J[R.__cacheKey];mt!==void 0&&(J[R.__cacheKey].usedTimes--,mt.usedTimes===0&&P(v)),R.__cacheKey=ct,R.__webglTexture=J[ct].texture}return B}function k(R,v,B){return Math.floor(Math.floor(R/B)/v)}function j(R,v,B,H){let ct=R.updateRanges;if(ct.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,v.width,v.height,B,H,v.data);else{ct.sort((Nt,vt)=>Nt.start-vt.start);let mt=0;for(let Nt=1;Nt<ct.length;Nt++){let vt=ct[mt],lt=ct[Nt],At=vt.start+vt.count,Dt=k(lt.start,v.width,4),Vt=k(vt.start,v.width,4);lt.start<=At+1&&Dt===Vt&&k(lt.start+lt.count-1,v.width,4)===Dt?vt.count=Math.max(vt.count,lt.start+lt.count-vt.start):(++mt,ct[mt]=lt)}ct.length=mt+1;let tt=e.getParameter(i.UNPACK_ROW_LENGTH),it=e.getParameter(i.UNPACK_SKIP_PIXELS),xt=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,v.width);for(let Nt=0,vt=ct.length;Nt<vt;Nt++){let lt=ct[Nt],At=Math.floor(lt.start/4),Dt=Math.ceil(lt.count/4),Vt=At%v.width,D=Math.floor(At/v.width),gt=Dt,Q=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Vt),e.pixelStorei(i.UNPACK_SKIP_ROWS,D),e.texSubImage2D(i.TEXTURE_2D,0,Vt,D,gt,Q,B,H,v.data)}R.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,tt),e.pixelStorei(i.UNPACK_SKIP_PIXELS,it),e.pixelStorei(i.UNPACK_SKIP_ROWS,xt)}}function _t(R,v,B){let H=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(H=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(H=i.TEXTURE_3D);let J=wt(R,v),ct=v.source;e.bindTexture(H,R.__webglTexture,i.TEXTURE0+B);let mt=n.get(ct);if(ct.version!==mt.__version||J===!0){if(e.activeTexture(i.TEXTURE0+B),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){let Q=ie.getPrimaries(ie.workingColorSpace),ht=v.colorSpace===jn?null:ie.getPrimaries(v.colorSpace),dt=v.colorSpace===jn||Q===ht?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt)}e.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment);let it=m(v.image,!1,s.maxTextureSize);it=pe(v,it);let xt=r.convert(v.format,v.colorSpace),Nt=r.convert(v.type),vt=x(v.internalFormat,xt,Nt,v.normalized,v.colorSpace,v.isVideoTexture);ot(H,v);let lt,At=v.mipmaps,Dt=v.isVideoTexture!==!0,Vt=mt.__version===void 0||J===!0,D=ct.dataReady,gt=T(v,it);if(v.isDepthTexture)vt=E(v.format===yi,v.type),Vt&&(Dt?e.texStorage2D(i.TEXTURE_2D,1,vt,it.width,it.height):e.texImage2D(i.TEXTURE_2D,0,vt,it.width,it.height,0,xt,Nt,null));else if(v.isDataTexture)if(At.length>0){Dt&&Vt&&e.texStorage2D(i.TEXTURE_2D,gt,vt,At[0].width,At[0].height);for(let Q=0,ht=At.length;Q<ht;Q++)lt=At[Q],Dt?D&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,lt.width,lt.height,xt,Nt,lt.data):e.texImage2D(i.TEXTURE_2D,Q,vt,lt.width,lt.height,0,xt,Nt,lt.data);v.generateMipmaps=!1}else Dt?(Vt&&e.texStorage2D(i.TEXTURE_2D,gt,vt,it.width,it.height),D&&j(v,it,xt,Nt)):e.texImage2D(i.TEXTURE_2D,0,vt,it.width,it.height,0,xt,Nt,it.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Dt&&Vt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,gt,vt,At[0].width,At[0].height,it.depth);for(let Q=0,ht=At.length;Q<ht;Q++)if(lt=At[Q],v.format!==sn)if(xt!==null)if(Dt){if(D)if(v.layerUpdates.size>0){let dt=Ec(lt.width,lt.height,v.format,v.type);for(let rt of v.layerUpdates){let Ut=lt.data.subarray(rt*dt/lt.data.BYTES_PER_ELEMENT,(rt+1)*dt/lt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,rt,lt.width,lt.height,1,xt,Ut)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,lt.width,lt.height,it.depth,xt,lt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,vt,lt.width,lt.height,it.depth,0,lt.data,0,0);else zt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Dt?D&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,lt.width,lt.height,it.depth,xt,Nt,lt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,Q,vt,lt.width,lt.height,it.depth,0,xt,Nt,lt.data);v.layerUpdates.size>0&&v.clearLayerUpdates()}else{Dt&&Vt&&e.texStorage2D(i.TEXTURE_2D,gt,vt,At[0].width,At[0].height);for(let Q=0,ht=At.length;Q<ht;Q++)lt=At[Q],v.format!==sn?xt!==null?Dt?D&&e.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,lt.width,lt.height,xt,lt.data):e.compressedTexImage2D(i.TEXTURE_2D,Q,vt,lt.width,lt.height,0,lt.data):zt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Dt?D&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,lt.width,lt.height,xt,Nt,lt.data):e.texImage2D(i.TEXTURE_2D,Q,vt,lt.width,lt.height,0,xt,Nt,lt.data)}else if(v.isDataArrayTexture)if(Dt){if(Vt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,gt,vt,it.width,it.height,it.depth),D)if(v.layerUpdates.size>0){let Q=Ec(it.width,it.height,v.format,v.type);for(let ht of v.layerUpdates){let dt=it.data.subarray(ht*Q/it.data.BYTES_PER_ELEMENT,(ht+1)*Q/it.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ht,it.width,it.height,1,xt,Nt,dt)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,it.width,it.height,it.depth,xt,Nt,it.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,vt,it.width,it.height,it.depth,0,xt,Nt,it.data);else if(v.isData3DTexture)Dt?(Vt&&e.texStorage3D(i.TEXTURE_3D,gt,vt,it.width,it.height,it.depth),D&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,it.width,it.height,it.depth,xt,Nt,it.data)):e.texImage3D(i.TEXTURE_3D,0,vt,it.width,it.height,it.depth,0,xt,Nt,it.data);else if(v.isFramebufferTexture){if(Vt)if(Dt)e.texStorage2D(i.TEXTURE_2D,gt,vt,it.width,it.height);else{let Q=it.width,ht=it.height;for(let dt=0;dt<gt;dt++)e.texImage2D(i.TEXTURE_2D,dt,vt,Q,ht,0,xt,Nt,null),Q>>=1,ht>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in i){let Q=i.canvas;if(Q.hasAttribute("layoutsubtree")||Q.setAttribute("layoutsubtree","true"),it.parentNode!==Q){Q.appendChild(it),f.add(v),Q.onpaint=ht=>{let dt=ht.changedElements;for(let rt of f)dt.includes(rt.image)&&(rt.needsUpdate=!0)},Q.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,it);else{let dt=i.RGBA,rt=i.RGBA,Ut=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,dt,rt,Ut,it)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(At.length>0){if(Dt&&Vt){let Q=Yt(At[0]);e.texStorage2D(i.TEXTURE_2D,gt,vt,Q.width,Q.height)}for(let Q=0,ht=At.length;Q<ht;Q++)lt=At[Q],Dt?D&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,xt,Nt,lt):e.texImage2D(i.TEXTURE_2D,Q,vt,xt,Nt,lt);v.generateMipmaps=!1}else if(Dt){if(Vt){let Q=Yt(it);e.texStorage2D(i.TEXTURE_2D,gt,vt,Q.width,Q.height)}D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,xt,Nt,it)}else e.texImage2D(i.TEXTURE_2D,0,vt,xt,Nt,it);p(v)&&y(H),mt.__version=ct.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function Bt(R,v,B){if(v.image.length!==6)return;let H=wt(R,v),J=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,R.__webglTexture,i.TEXTURE0+B);let ct=n.get(J);if(J.version!==ct.__version||H===!0){e.activeTexture(i.TEXTURE0+B);let mt=ie.getPrimaries(ie.workingColorSpace),tt=v.colorSpace===jn?null:ie.getPrimaries(v.colorSpace),it=v.colorSpace===jn||mt===tt?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,it);let xt=v.isCompressedTexture||v.image[0].isCompressedTexture,Nt=v.image[0]&&v.image[0].isDataTexture,vt=[];for(let rt=0;rt<6;rt++)!xt&&!Nt?vt[rt]=m(v.image[rt],!0,s.maxCubemapSize):vt[rt]=Nt?v.image[rt].image:v.image[rt],vt[rt]=pe(v,vt[rt]);let lt=vt[0],At=r.convert(v.format,v.colorSpace),Dt=r.convert(v.type),Vt=x(v.internalFormat,At,Dt,v.normalized,v.colorSpace),D=v.isVideoTexture!==!0,gt=ct.__version===void 0||H===!0,Q=J.dataReady,ht=T(v,lt);ot(i.TEXTURE_CUBE_MAP,v);let dt;if(xt){D&&gt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Vt,lt.width,lt.height);for(let rt=0;rt<6;rt++){dt=vt[rt].mipmaps;for(let Ut=0;Ut<dt.length;Ut++){let Pt=dt[Ut];v.format!==sn?At!==null?D?Q&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut,0,0,Pt.width,Pt.height,At,Pt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut,Vt,Pt.width,Pt.height,0,Pt.data):zt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?Q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut,0,0,Pt.width,Pt.height,At,Dt,Pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut,Vt,Pt.width,Pt.height,0,At,Dt,Pt.data)}}}else{if(dt=v.mipmaps,D&&gt){dt.length>0&&ht++;let rt=Yt(vt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Vt,rt.width,rt.height)}for(let rt=0;rt<6;rt++)if(Nt){D?Q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,0,0,vt[rt].width,vt[rt].height,At,Dt,vt[rt].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,Vt,vt[rt].width,vt[rt].height,0,At,Dt,vt[rt].data);for(let Ut=0;Ut<dt.length;Ut++){let me=dt[Ut].image[rt].image;D?Q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut+1,0,0,me.width,me.height,At,Dt,me.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut+1,Vt,me.width,me.height,0,At,Dt,me.data)}}else{D?Q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,0,0,At,Dt,vt[rt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,Vt,At,Dt,vt[rt]);for(let Ut=0;Ut<dt.length;Ut++){let Pt=dt[Ut];D?Q&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut+1,0,0,At,Dt,Pt.image[rt]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,Ut+1,Vt,At,Dt,Pt.image[rt])}}}p(v)&&y(i.TEXTURE_CUBE_MAP),ct.__version=J.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function yt(R,v,B,H,J,ct){let mt=r.convert(B.format,B.colorSpace),tt=r.convert(B.type),it=x(B.internalFormat,mt,tt,B.normalized,B.colorSpace),xt=n.get(v),Nt=n.get(B);if(Nt.__renderTarget=v,!xt.__hasExternalTextures){let vt=Math.max(1,v.width>>ct),lt=Math.max(1,v.height>>ct);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,ct,it,vt,lt,v.depth,0,mt,tt,null):e.texImage2D(J,ct,it,vt,lt,0,mt,tt,null)}e.bindFramebuffer(i.FRAMEBUFFER,R),Zt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,H,J,Nt.__webglTexture,0,Ot(v)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,H,J,Nt.__webglTexture,ct),e.bindFramebuffer(i.FRAMEBUFFER,null)}function kt(R,v,B){if(i.bindRenderbuffer(i.RENDERBUFFER,R),v.depthBuffer){let H=v.depthTexture,J=H&&H.isDepthTexture?H.type:null,ct=E(v.stencilBuffer,J),mt=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Zt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ot(v),ct,v.width,v.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ot(v),ct,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ct,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,mt,i.RENDERBUFFER,R)}else{let H=v.textures;for(let J=0;J<H.length;J++){let ct=H[J],mt=r.convert(ct.format,ct.colorSpace),tt=r.convert(ct.type),it=x(ct.internalFormat,mt,tt,ct.normalized,ct.colorSpace);Zt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ot(v),it,v.width,v.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ot(v),it,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,it,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ye(R,v,B){let H=v.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,R),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=n.get(v.depthTexture);if(J.__renderTarget=v,(!J.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),H){if(J.__webglInit===void 0&&(J.__webglInit=!0,v.depthTexture.addEventListener("dispose",b)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),ot(i.TEXTURE_CUBE_MAP,v.depthTexture);let xt=r.convert(v.depthTexture.format),Nt=r.convert(v.depthTexture.type),vt;v.depthTexture.format===Dn?vt=i.DEPTH_COMPONENT24:v.depthTexture.format===yi&&(vt=i.DEPTH24_STENCIL8);for(let lt=0;lt<6;lt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+lt,0,vt,v.width,v.height,0,xt,Nt,null)}}else st(v.depthTexture,0);let ct=J.__webglTexture,mt=Ot(v),tt=H?i.TEXTURE_CUBE_MAP_POSITIVE_X+B:i.TEXTURE_2D,it=v.depthTexture.format===yi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(v.depthTexture.format===Dn)Zt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,it,tt,ct,0,mt):i.framebufferTexture2D(i.FRAMEBUFFER,it,tt,ct,0);else if(v.depthTexture.format===yi)Zt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,it,tt,ct,0,mt):i.framebufferTexture2D(i.FRAMEBUFFER,it,tt,ct,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function V(R){let v=n.get(R),B=R.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==R.depthTexture){let H=R.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),H){let J=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,H.removeEventListener("dispose",J)};H.addEventListener("dispose",J),v.__depthDisposeCallback=J}v.__boundDepthTexture=H}if(R.depthTexture&&!v.__autoAllocateDepthBuffer)if(B)for(let H=0;H<6;H++)ye(v.__webglFramebuffer[H],R,H);else{let H=R.texture.mipmaps;H&&H.length>0?ye(v.__webglFramebuffer[0],R,0):ye(v.__webglFramebuffer,R,0)}else if(B){v.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[H]),v.__webglDepthbuffer[H]===void 0)v.__webglDepthbuffer[H]=i.createRenderbuffer(),kt(v.__webglDepthbuffer[H],R,!1);else{let J=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ct=v.__webglDepthbuffer[H];i.bindRenderbuffer(i.RENDERBUFFER,ct),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,ct)}}else{let H=R.texture.mipmaps;if(H&&H.length>0?e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),kt(v.__webglDepthbuffer,R,!1);else{let J=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ct=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ct),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,ct)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function q(R,v,B){let H=n.get(R);v!==void 0&&yt(H.__webglFramebuffer,R,R.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&V(R)}function ft(R){let v=R.texture,B=n.get(R),H=n.get(v);R.addEventListener("dispose",g);let J=R.textures,ct=R.isWebGLCubeRenderTarget===!0,mt=J.length>1;if(mt||(H.__webglTexture===void 0&&(H.__webglTexture=i.createTexture()),H.__version=v.version,a.memory.textures++),ct){B.__webglFramebuffer=[];for(let tt=0;tt<6;tt++)if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer[tt]=[];for(let it=0;it<v.mipmaps.length;it++)B.__webglFramebuffer[tt][it]=i.createFramebuffer()}else B.__webglFramebuffer[tt]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer=[];for(let tt=0;tt<v.mipmaps.length;tt++)B.__webglFramebuffer[tt]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(mt)for(let tt=0,it=J.length;tt<it;tt++){let xt=n.get(J[tt]);xt.__webglTexture===void 0&&(xt.__webglTexture=i.createTexture(),a.memory.textures++)}if(R.samples>0&&Zt(R)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let tt=0;tt<J.length;tt++){let it=J[tt];B.__webglColorRenderbuffer[tt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[tt]);let xt=r.convert(it.format,it.colorSpace),Nt=r.convert(it.type),vt=x(it.internalFormat,xt,Nt,it.normalized,it.colorSpace,R.isXRRenderTarget===!0),lt=Ot(R);i.renderbufferStorageMultisample(i.RENDERBUFFER,lt,vt,R.width,R.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+tt,i.RENDERBUFFER,B.__webglColorRenderbuffer[tt])}i.bindRenderbuffer(i.RENDERBUFFER,null),R.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),kt(B.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ct){e.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture),ot(i.TEXTURE_CUBE_MAP,v);for(let tt=0;tt<6;tt++)if(v.mipmaps&&v.mipmaps.length>0)for(let it=0;it<v.mipmaps.length;it++)yt(B.__webglFramebuffer[tt][it],R,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+tt,it);else yt(B.__webglFramebuffer[tt],R,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0);p(v)&&y(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(mt){for(let tt=0,it=J.length;tt<it;tt++){let xt=J[tt],Nt=n.get(xt),vt=i.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(vt=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(vt,Nt.__webglTexture),ot(vt,xt),yt(B.__webglFramebuffer,R,xt,i.COLOR_ATTACHMENT0+tt,vt,0),p(xt)&&y(vt)}e.unbindTexture()}else{let tt=i.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(tt=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(tt,H.__webglTexture),ot(tt,v),v.mipmaps&&v.mipmaps.length>0)for(let it=0;it<v.mipmaps.length;it++)yt(B.__webglFramebuffer[it],R,v,i.COLOR_ATTACHMENT0,tt,it);else yt(B.__webglFramebuffer,R,v,i.COLOR_ATTACHMENT0,tt,0);p(v)&&y(tt),e.unbindTexture()}R.depthBuffer&&V(R)}function pt(R){let v=R.textures;for(let B=0,H=v.length;B<H;B++){let J=v[B];if(p(J)){let ct=w(R),mt=n.get(J).__webglTexture;e.bindTexture(ct,mt),y(ct),e.unbindTexture()}}}let Et=[],Ht=[];function Jt(R){if(R.samples>0){if(Zt(R)===!1){let v=R.textures,B=R.width,H=R.height,J=i.COLOR_BUFFER_BIT,ct=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,mt=n.get(R),tt=v.length>1;if(tt)for(let xt=0;xt<v.length;xt++)e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,mt.__webglMultisampledFramebuffer);let it=R.texture.mipmaps;it&&it.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglFramebuffer);for(let xt=0;xt<v.length;xt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),tt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,mt.__webglColorRenderbuffer[xt]);let Nt=n.get(v[xt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Nt,0)}i.blitFramebuffer(0,0,B,H,0,0,B,H,J,i.NEAREST),l===!0&&(Et.length=0,Ht.length=0,Et.push(i.COLOR_ATTACHMENT0+xt),R.depthBuffer&&R.storeMultisampledDepthBuffer===!1&&(Et.push(ct),Ht.push(ct),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ht)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Et))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),tt)for(let xt=0;xt<v.length;xt++){e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xt,i.RENDERBUFFER,mt.__webglColorRenderbuffer[xt]);let Nt=n.get(v[xt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xt,i.TEXTURE_2D,Nt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,mt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.storeMultisampledDepthBuffer===!1&&l){let v=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Ot(R){return Math.min(s.maxSamples,R.samples)}function Zt(R){let v=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function I(R){let v=a.render.frame;h.get(R)!==v&&(h.set(R,v),R.update())}function pe(R,v){let B=R.colorSpace,H=R.format,J=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||B!==$s&&B!==jn&&(ie.getTransfer(B)===le?(H!==sn||J!==Je)&&zt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xt("WebGLTextures: Unsupported texture color space:",B)),v}function Yt(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=$,this.resetTextureUnits=X,this.getTextureUnits=L,this.setTextureUnits=z,this.setTexture2D=st,this.setTexture2DArray=Z,this.setTexture3D=nt,this.setTextureCube=F,this.rebindTextures=q,this.setupRenderTarget=ft,this.updateRenderTargetMipmap=pt,this.updateMultisampleRenderTarget=Jt,this.setupDepthRenderbuffer=V,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=Zt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function B_(i,t){function e(n,s=jn){let r,a=ie.getTransfer(s);if(n===Je)return i.UNSIGNED_BYTE;if(n===fo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===po)return i.UNSIGNED_SHORT_5_5_5_1;if(n===fc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===pc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===uc)return i.BYTE;if(n===dc)return i.SHORT;if(n===Ts)return i.UNSIGNED_SHORT;if(n===uo)return i.INT;if(n===wn)return i.UNSIGNED_INT;if(n===nn)return i.FLOAT;if(n===An)return i.HALF_FLOAT;if(n===mc)return i.ALPHA;if(n===gc)return i.RGB;if(n===sn)return i.RGBA;if(n===Dn)return i.DEPTH_COMPONENT;if(n===yi)return i.DEPTH_STENCIL;if(n===mo)return i.RED;if(n===go)return i.RED_INTEGER;if(n===Mi)return i.RG;if(n===_o)return i.RG_INTEGER;if(n===xo)return i.RGBA_INTEGER;if(n===Lr||n===Dr||n===Nr||n===Ur)if(a===le)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Lr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Dr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Nr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Lr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Dr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Nr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ur)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===vo||n===yo||n===Mo||n===So)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===vo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===yo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Mo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===So)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===bo||n===Eo||n===To||n===wo||n===Ao||n===Fr||n===Ro)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===bo||n===Eo)return a===le?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===To)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===wo)return r.COMPRESSED_R11_EAC;if(n===Ao)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Fr)return r.COMPRESSED_RG11_EAC;if(n===Ro)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Co||n===Po||n===Io||n===Lo||n===Do||n===No||n===Uo||n===Fo||n===Oo||n===Bo||n===zo||n===Ho||n===Vo||n===ko)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Co)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Po)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Io)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Lo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Do)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===No)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Uo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Fo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Oo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Bo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===zo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ho)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Vo)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ko)return a===le?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Go||n===Wo||n===Xo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Go)return a===le?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Wo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===qo||n===Yo||n===Or||n===Zo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===qo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Yo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Or)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Zo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ws?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var z_=`
void main() {
...
}`,Bc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new cr(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new He({vertexShader:z_,fragmentShader:H_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new se(new En(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},zc=class extends Nn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,f=null,u=null,d=null,_=null,M=typeof XRWebGLBinding<"u",m=new Bc,p={},y=e.getContextAttributes(),w=null,x=null,E=[],T=[],b=new ut,g=null,A=null,P=new We;P.viewport=new he;let U=new We;U.viewport=new he;let O=[P,U],X=new oo,L=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let j=E[k];return j===void 0&&(j=new fs,E[k]=j),j.getTargetRaySpace()},this.getControllerGrip=function(k){let j=E[k];return j===void 0&&(j=new fs,E[k]=j),j.getGripSpace()},this.getHand=function(k){let j=E[k];return j===void 0&&(j=new fs,E[k]=j),j.getHandSpace()};function $(k){let j=T.indexOf(k.inputSource);if(j===-1)return;let _t=E[j];_t!==void 0&&(_t.update(k.inputSource,k.frame,c||a),_t.dispatchEvent({type:k.type,data:k.inputSource}))}function K(){s.removeEventListener("select",$),s.removeEventListener("selectstart",$),s.removeEventListener("selectend",$),s.removeEventListener("squeeze",$),s.removeEventListener("squeezestart",$),s.removeEventListener("squeezeend",$),s.removeEventListener("end",K),s.removeEventListener("inputsourceschange",st);for(let k=0;k<E.length;k++){let j=T[k];j!==null&&(T[k]=null,E[k].disconnect(j))}L=null,z=null,m.reset();for(let k in p)delete p[k];if(t.setRenderTarget(w),d=null,u=null,f=null,s=null,x=null,wt.stop(),n.isPresenting=!1,t.setPixelRatio(g),t.setSize(b.width,b.height,!1),A!==null){let k=A.camera;k.fov=A.fov,k.zoom=A.zoom,k.updateProjectionMatrix(),A=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){r=k,n.isPresenting===!0&&zt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){o=k,n.isPresenting===!0&&zt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(k){c=k},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return f===null&&M&&(f=new XRWebGLBinding(s,e)),f},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(k){if(s=k,s!==null){if(w=t.getRenderTarget(),s.addEventListener("select",$),s.addEventListener("selectstart",$),s.addEventListener("selectend",$),s.addEventListener("squeeze",$),s.addEventListener("squeezestart",$),s.addEventListener("squeezeend",$),s.addEventListener("end",K),s.addEventListener("inputsourceschange",st),y.xrCompatible!==!0&&await e.makeXRCompatible(),g=t.getPixelRatio(),t.getSize(b),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let _t=null,Bt=null,yt=null;y.depth&&(yt=y.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,_t=y.stencil?yi:Dn,Bt=y.stencil?ws:wn);let kt={colorFormat:e.RGBA8,depthFormat:yt,scaleFactor:r};f=this.getBinding(),u=f.createProjectionLayer(kt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),x=new Ze(u.textureWidth,u.textureHeight,{format:sn,type:Je,depthTexture:new ci(u.textureWidth,u.textureHeight,Bt,void 0,void 0,void 0,void 0,void 0,void 0,_t),stencilBuffer:y.stencil,colorSpace:t.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1,storeMultisampledDepthBuffer:u.ignoreDepthValues===!1,storeMultisampledStencilBuffer:u.ignoreDepthValues===!1})}else{let _t={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:r};d=new XRWebGLLayer(s,e,_t),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),x=new Ze(d.framebufferWidth,d.framebufferHeight,{format:sn,type:Je,colorSpace:t.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1,storeMultisampledDepthBuffer:d.ignoreDepthValues===!1,storeMultisampledStencilBuffer:d.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),wt.setContext(s),wt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function st(k){for(let j=0;j<k.removed.length;j++){let _t=k.removed[j],Bt=T.indexOf(_t);Bt>=0&&(T[Bt]=null,E[Bt].disconnect(_t))}for(let j=0;j<k.added.length;j++){let _t=k.added[j],Bt=T.indexOf(_t);if(Bt===-1){for(let kt=0;kt<E.length;kt++)if(kt>=T.length){T.push(_t),Bt=kt;break}else if(T[kt]===null){T[kt]=_t,Bt=kt;break}if(Bt===-1)break}let yt=E[Bt];yt&&yt.connect(_t)}}let Z=new C,nt=new C;function F(k,j,_t){Z.setFromMatrixPosition(j.matrixWorld),nt.setFromMatrixPosition(_t.matrixWorld);let Bt=Z.distanceTo(nt),yt=j.projectionMatrix.elements,kt=_t.projectionMatrix.elements,ye=yt[14]/(yt[10]-1),V=yt[14]/(yt[10]+1),q=(yt[9]+1)/yt[5],ft=(yt[9]-1)/yt[5],pt=(yt[8]-1)/yt[0],Et=(kt[8]+1)/kt[0],Ht=ye*pt,Jt=ye*Et,Ot=Bt/(-pt+Et),Zt=Ot*-pt;if(j.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(Zt),k.translateZ(Ot),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),yt[10]===-1)k.projectionMatrix.copy(j.projectionMatrix),k.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{let I=ye+Ot,pe=V+Ot,Yt=Ht-Zt,R=Jt+(Bt-Zt),v=q*V/pe*I,B=ft*V/pe*I;k.projectionMatrix.makePerspective(Yt,R,v,B,I,pe),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function at(k,j){j===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(j.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(s===null)return;let j=k.near,_t=k.far;m.texture!==null&&(m.depthNear>0&&(j=m.depthNear),m.depthFar>0&&(_t=m.depthFar)),X.near=U.near=P.near=j,X.far=U.far=P.far=_t,(L!==X.near||z!==X.far)&&(s.updateRenderState({depthNear:X.near,depthFar:X.far}),L=X.near,z=X.far),X.layers.mask=k.layers.mask|6,P.layers.mask=X.layers.mask&-5,U.layers.mask=X.layers.mask&-3;let Bt=k.parent,yt=X.cameras;at(X,Bt);for(let kt=0;kt<yt.length;kt++)at(yt[kt],Bt);yt.length===2?F(X,P,U):X.projectionMatrix.copy(P.projectionMatrix),A===null&&k.isPerspectiveCamera&&(A={camera:k,fov:k.fov,zoom:k.zoom}),et(k,X,Bt)};function et(k,j,_t){_t===null?k.matrix.copy(j.matrixWorld):(k.matrix.copy(_t.matrixWorld),k.matrix.invert(),k.matrix.multiply(j.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy(j.projectionMatrix),k.projectionMatrixInverse.copy(j.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=us*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return X},this.getFoveation=function(){if(!(u===null&&d===null))return l},this.setFoveation=function(k){l=k,u!==null&&(u.fixedFoveation=k),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=k)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(X)},this.getCameraTexture=function(k){return p[k]};let Tt=null;function ot(k,j){if(h=j.getViewerPose(c||a),_=j,h!==null){let _t=h.views;d!==null&&(t.setRenderTargetFramebuffer(x,d.framebuffer),t.setRenderTarget(x));let Bt=!1;_t.length!==X.cameras.length&&(X.cameras.length=0,Bt=!0);for(let V=0;V<_t.length;V++){let q=_t[V],ft=null;if(d!==null)ft=d.getViewport(q);else{let Et=f.getViewSubImage(u,q);ft=Et.viewport,V===0&&(t.setRenderTargetTextures(x,Et.colorTexture,Et.depthStencilTexture),t.setRenderTarget(x))}let pt=O[V];pt===void 0&&(pt=new We,pt.layers.enable(V),pt.viewport=new he,O[V]=pt),pt.matrix.fromArray(q.transform.matrix),pt.matrix.decompose(pt.position,pt.quaternion,pt.scale),pt.projectionMatrix.fromArray(q.projectionMatrix),pt.projectionMatrixInverse.copy(pt.projectionMatrix).invert(),pt.viewport.set(ft.x,ft.y,ft.width,ft.height),V===0&&(X.matrix.copy(pt.matrix),X.matrix.decompose(X.position,X.quaternion,X.scale)),Bt===!0&&X.cameras.push(pt)}let yt=s.enabledFeatures;if(yt&&yt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){f=n.getBinding();let V=f.getDepthInformation(_t[0]);V&&V.isValid&&V.texture&&m.init(V,s.renderState)}if(yt&&yt.includes("camera-access")&&M){t.state.unbindTexture(),f=n.getBinding();for(let V=0;V<_t.length;V++){let q=_t[V].camera;if(q){let ft=p[q];ft||(ft=new cr,p[q]=ft);let pt=f.getCameraImage(q);ft.sourceTexture=pt}}}}for(let _t=0;_t<E.length;_t++){let Bt=T[_t],yt=E[_t];Bt!==null&&yt!==void 0&&yt.update(Bt,j,c||a)}Tt&&Tt(k,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),_=null}let wt=new rd;wt.setAnimationLoop(ot),this.setAnimationLoop=function(k){Tt=k},this.dispose=function(){}}},V_=new $t,ud=new qt;ud.set(-1,0,0,0,1,0,0,0,1);function k_(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Mc(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,y,w,x){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),f(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&d(m,p,x)):p.isMeshMatcapMaterial?(r(m,p),_(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),M(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,y,w):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===qe&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===qe&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let y=t.get(p),w=y.envMap,x=y.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(V_.makeRotationFromEuler(x)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(ud),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,y,w){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*y,m.scale.value=w*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,y){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===qe&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function M(m,p){let y=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function G_(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,E){let T=E.program;n.uniformBlockBinding(x,T)}function c(x,E){let T=s[x.id];T===void 0&&(m(x),T=h(x),s[x.id]=T,x.addEventListener("dispose",y));let b=E.program;n.updateUBOMapping(x,b);let g=t.render.frame;r[x.id]!==g&&(u(x),r[x.id]=g)}function h(x){let E=f();x.__bindingPointIndex=E;let T=i.createBuffer(),b=x.__size,g=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,b,g),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,T),T}function f(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return Xt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(x){let E=s[x.id],T=x.uniforms,b=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let g=0,A=T.length;g<A;g++){let P=T[g];if(Array.isArray(P))for(let U=0,O=P.length;U<O;U++)d(P[U],g,U,b);else d(P,g,0,b)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(x,E,T,b){if(M(x,E,T,b)===!0){let g=x.__offset,A=x.value;if(Array.isArray(A)){let P=0;for(let U=0;U<A.length;U++){let O=A[U],X=p(O);_(O,x.__data,P),typeof O!="number"&&typeof O!="boolean"&&!O.isMatrix3&&!ArrayBuffer.isView(O)&&(P+=X.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(A,x.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,g,x.__data)}}function _(x,E,T){typeof x=="number"||typeof x=="boolean"?E[0]=x:x.isMatrix3?(E[0]=x.elements[0],E[1]=x.elements[1],E[2]=x.elements[2],E[3]=0,E[4]=x.elements[3],E[5]=x.elements[4],E[6]=x.elements[5],E[7]=0,E[8]=x.elements[6],E[9]=x.elements[7],E[10]=x.elements[8],E[11]=0):ArrayBuffer.isView(x)?E.set(new x.constructor(x.buffer,x.byteOffset,E.length)):x.toArray(E,T)}function M(x,E,T,b){let g=x.value,A=E+"_"+T;if(b[A]===void 0)return typeof g=="number"||typeof g=="boolean"?b[A]=g:ArrayBuffer.isView(g)?b[A]=g.slice():b[A]=g.clone(),!0;{let P=b[A];if(typeof g=="number"||typeof g=="boolean"){if(P!==g)return b[A]=g,!0}else{if(ArrayBuffer.isView(g))return!0;if(P.equals(g)===!1)return P.copy(g),!0}}return!1}function m(x){let E=x.uniforms,T=0,b=16;for(let A=0,P=E.length;A<P;A++){let U=Array.isArray(E[A])?E[A]:[E[A]];for(let O=0,X=U.length;O<X;O++){let L=U[O],z=Array.isArray(L.value)?L.value:[L.value];for(let $=0,K=z.length;$<K;$++){let st=z[$],Z=p(st),nt=T%b,F=nt%Z.boundary,at=nt+F;T+=F,at!==0&&b-at<Z.storage&&(T+=b-at),L.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),L.__offset=T,T+=Z.storage}}}let g=T%b;return g>0&&(T+=b-g),x.__size=T,x.__cache={},this}function p(x){let E={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(E.boundary=4,E.storage=4):x.isVector2?(E.boundary=8,E.storage=8):x.isVector3||x.isColor?(E.boundary=16,E.storage=12):x.isVector4?(E.boundary=16,E.storage=16):x.isMatrix3?(E.boundary=48,E.storage=48):x.isMatrix4?(E.boundary=64,E.storage=64):x.isTexture?zt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(E.boundary=16,E.storage=x.byteLength):zt("WebGLRenderer: Unsupported uniform value type.",x),E}function y(x){let E=x.target;E.removeEventListener("dispose",y);let T=a.indexOf(E.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(s[E.id]),delete s[E.id],delete r[E.id]}function w(){for(let x in s)i.deleteBuffer(s[x]);a=[],s={},r={}}return{bind:l,update:c,dispose:w}}var W_=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),zn=null;function X_(){return zn===null&&(zn=new ms(W_,16,16,Mi,An),zn.name="DFG_LUT",zn.minFilter=Ue,zn.magFilter=Ue,zn.wrapS=Ln,zn.wrapT=Ln,zn.generateMipmaps=!1,zn.needsUpdate=!0),zn}var nl=class{constructor(t={}){let{canvas:e=Tu(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:u=!1,outputBufferType:d=Je}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;let M=d,m=new Set([xo,_o,go]),p=new Set([Je,wn,Ts,ws,fo,po]),y=new Uint32Array(4),w=new Int32Array(4),x=new C,E=null,T=null,b=[],g=[],A=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let P=this,U=!1,O=null,X=null,L=null,z=null;this._outputColorSpace=we;let $=0,K=0,st=null,Z=-1,nt=null,F=new he,at=new he,et=null,Tt=new Gt(0),ot=0,wt=e.width,k=e.height,j=1,_t=null,Bt=null,yt=new he(0,0,wt,k),kt=new he(0,0,wt,k),ye=!1,V=new _s,q=!1,ft=!1,pt=new $t,Et=new C,Ht=new he,Jt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ot=!1;function Zt(){return st===null?j:1}let I=n;function pe(S,N){return e.getContext(S,N)}let Yt,R,v,B,H,J,ct,mt,tt,it,xt,Nt,vt,lt,At,Dt,Vt,D,gt,Q,ht,dt,rt;try{let S={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",me,!1),e.addEventListener("webglcontextrestored",ae,!1),e.addEventListener("webglcontextcreationerror",dn,!1),I===null){let N="webgl2";if(I=pe(N,S),I===null)throw pe(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Ut()}catch(S){throw e.removeEventListener("webglcontextlost",me,!1),e.removeEventListener("webglcontextrestored",ae,!1),e.removeEventListener("webglcontextcreationerror",dn,!1),Xt("WebGLRenderer: "+S.message),S}function Ut(){Yt=new Qg(I),Yt.init(),ht=new B_(I,Yt),R=new kg(I,Yt,t,ht),v=new F_(I,Yt),R.reversedDepthBuffer&&u&&v.buffers.depth.setReversed(!0),X=I.createFramebuffer(),L=I.createFramebuffer(),z=I.createFramebuffer(),B=new e0(I),H=new S_,J=new O_(I,Yt,v,H,R,ht,B),ct=new Kg(P),mt=new ip(I),dt=new Hg(I,mt),tt=new jg(I,mt,B,dt),it=new i0(I,tt,mt,dt,B),D=new n0(I,R,J),At=new Gg(H),xt=new M_(P,ct,Yt,R,dt,At),Nt=new k_(P,H),vt=new E_,lt=new P_(Yt),Vt=new zg(P,ct,v,it,_,l),Dt=new U_(P,it,R),rt=new G_(I,B,R,v),gt=new Vg(I,Yt,B),Q=new t0(I,Yt,B),B.programs=xt.programs,P.capabilities=R,P.extensions=Yt,P.properties=H,P.renderLists=vt,P.shadowMap=Dt,P.state=v,P.info=B}M!==Je&&(A=new r0(M,e.width,e.height,o,s,r));let Pt=new zc(P,I);this.xr=Pt,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){let S=Yt.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){let S=Yt.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(S){S!==void 0&&(j=S,this.setSize(wt,k,!1))},this.getSize=function(S){return S.set(wt,k)},this.setSize=function(S,N,Y=!0){if(Pt.isPresenting){zt("WebGLRenderer: Can't change size while VR device is presenting.");return}wt=S,k=N,e.width=Math.floor(S*j),e.height=Math.floor(N*j),Y===!0&&(e.style.width=S+"px",e.style.height=N+"px"),A!==null&&A.setSize(e.width,e.height),this.setViewport(0,0,S,N)},this.getDrawingBufferSize=function(S){return S.set(wt*j,k*j).floor()},this.setDrawingBufferSize=function(S,N,Y){wt=S,k=N,j=Y,e.width=Math.floor(S*Y),e.height=Math.floor(N*Y),this.setViewport(0,0,S,N)},this.setEffects=function(S){if(M===Je){Xt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let N=0;N<S.length;N++)if(S[N].isOutputPass===!0){zt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(F)},this.getViewport=function(S){return S.copy(yt)},this.setViewport=function(S,N,Y,G){S.isVector4?yt.set(S.x,S.y,S.z,S.w):yt.set(S,N,Y,G),v.viewport(F.copy(yt).multiplyScalar(j).round())},this.getScissor=function(S){return S.copy(kt)},this.setScissor=function(S,N,Y,G){S.isVector4?kt.set(S.x,S.y,S.z,S.w):kt.set(S,N,Y,G),v.scissor(at.copy(kt).multiplyScalar(j).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(S){v.setScissorTest(ye=S)},this.setOpaqueSort=function(S){_t=S},this.setTransparentSort=function(S){Bt=S},this.getClearColor=function(S){return S.copy(Vt.getClearColor())},this.setClearColor=function(){Vt.setClearColor(...arguments)},this.getClearAlpha=function(){return Vt.getClearAlpha()},this.setClearAlpha=function(){Vt.setClearAlpha(...arguments)},this.clear=function(S=!0,N=!0,Y=!0){let G=0;if(S){let W=!1;if(st!==null){let bt=st.texture.format;W=m.has(bt)}if(W){let bt=st.texture.type,Ct=p.has(bt),St=Vt.getClearColor(),It=Vt.getClearAlpha(),Ft=St.r,Kt=St.g,ee=St.b;Ct?(y[0]=Ft,y[1]=Kt,y[2]=ee,y[3]=It,I.clearBufferuiv(I.COLOR,0,y)):(w[0]=Ft,w[1]=Kt,w[2]=ee,w[3]=It,I.clearBufferiv(I.COLOR,0,w))}else G|=I.COLOR_BUFFER_BIT}N&&(G|=I.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Y&&(G|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&I.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),O=S},this.dispose=function(){e.removeEventListener("webglcontextlost",me,!1),e.removeEventListener("webglcontextrestored",ae,!1),e.removeEventListener("webglcontextcreationerror",dn,!1),Vt.dispose(),vt.dispose(),lt.dispose(),H.dispose(),ct.dispose(),it.dispose(),dt.dispose(),rt.dispose(),xt.dispose(),Pt.dispose(),Pt.removeEventListener("sessionstart",Yc),Pt.removeEventListener("sessionend",Zc),Ei.stop()};function me(S){S.preventDefault(),js("WebGLRenderer: Context Lost."),U=!0}function ae(){js("WebGLRenderer: Context Restored."),U=!1;let S=B.autoReset,N=Dt.enabled,Y=Dt.autoUpdate,G=Dt.needsUpdate,W=Dt.type;Ut(),B.autoReset=S,Dt.enabled=N,Dt.autoUpdate=Y,Dt.needsUpdate=G,Dt.type=W}function dn(S){Xt("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Cn(S){let N=S.target;N.removeEventListener("dispose",Cn),Td(N)}function Td(S){wd(S),H.remove(S)}function wd(S){let N=H.get(S).programs;N!==void 0&&(N.forEach(function(Y){xt.releaseProgram(Y)}),S.isShaderMaterial&&xt.releaseShaderCache(S))}this.renderBufferDirect=function(S,N,Y,G,W,bt){N===null&&(N=Jt);let Ct=W.isMesh&&W.matrixWorld.determinantAffine()<0,St=Cd(S,N,Y,G,W);v.setMaterial(G,Ct);let It=Y.index,Ft=1;if(G.wireframe===!0){if(It=tt.getWireframeAttribute(Y),It===void 0)return;Ft=2}let Kt=Y.drawRange,ee=Y.attributes.position,Lt=Kt.start*Ft,oe=(Kt.start+Kt.count)*Ft;bt!==null&&(Lt=Math.max(Lt,bt.start*Ft),oe=Math.min(oe,(bt.start+bt.count)*Ft)),It!==null?(Lt=Math.max(Lt,0),oe=Math.min(oe,It.count)):ee!=null&&(Lt=Math.max(Lt,0),oe=Math.min(oe,ee.count));let Re=oe-Lt;if(Re<0||Re===1/0)return;dt.setup(W,G,St,Y,It);let _e,fe=gt;if(It!==null&&(_e=mt.get(It),fe=Q,fe.setIndex(_e)),W.isMesh)G.wireframe===!0?(v.setLineWidth(G.wireframeLinewidth*Zt()),fe.setMode(I.LINES)):fe.setMode(I.TRIANGLES);else if(W.isLine){let Oe=G.linewidth;Oe===void 0&&(Oe=1),v.setLineWidth(Oe*Zt()),W.isLineSegments?fe.setMode(I.LINES):W.isLineLoop?fe.setMode(I.LINE_LOOP):fe.setMode(I.LINE_STRIP)}else W.isPoints?fe.setMode(I.POINTS):W.isSprite&&fe.setMode(I.TRIANGLES);if(W.isBatchedMesh)if(Yt.get("WEBGL_multi_draw"))fe.renderMultiDraw(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount);else{let Oe=W._multiDrawStarts,Rt=W._multiDrawCounts,ke=W._multiDrawCount,re=It?mt.get(It).bytesPerElement:1,rn=H.get(G).currentProgram.getUniforms();for(let Pn=0;Pn<ke;Pn++)rn.setValue(I,"_gl_DrawID",Pn),fe.render(Oe[Pn]/re,Rt[Pn])}else if(W.isInstancedMesh)fe.renderInstances(Lt,Re,W.count);else if(Y.isInstancedBufferGeometry){let Oe=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,Rt=Math.min(Y.instanceCount,Oe);fe.renderInstances(Lt,Re,Rt)}else fe.render(Lt,Re)};function qc(S,N,Y,G){O!==null&&S.isNodeMaterial&&O.setObject(G,S),q===!0&&At.setState(S,Y,!1),S.transparent===!0&&S.side===Ye&&S.forceSinglePass===!1?(S.side=qe,S.needsUpdate=!0,Xr(S,N,G),S.side=gi,S.needsUpdate=!0,Xr(S,N,G),S.side=Ye):Xr(S,N,G)}this.compile=function(S,N,Y=null){Y===null&&(Y=S),O!==null&&O.renderStart(S,N,Y),T=lt.get(Y),T.init(N),g.push(T),Y.traverseVisible(function(W){W.isLight&&W.layers.test(N.layers)&&(T.pushLight(W),W.castShadow&&T.pushShadow(W))}),S!==Y&&S.traverseVisible(function(W){W.isLight&&W.layers.test(N.layers)&&(T.pushLight(W),W.castShadow&&T.pushShadow(W))}),T.setupLights(),O!==null&&O.updateLights(T.state.lightsArray),ft=this.localClippingEnabled,q=At.init(this.clippingPlanes,ft),q===!0&&At.setGlobalState(this.clippingPlanes,N),O!==null&&Dt.render(T.state.shadowsArray,Y,N);let G=new Set;return S.traverse(function(W){if(!(W.isMesh||W.isPoints||W.isLine||W.isSprite))return;let bt=W.material;if(bt)if(Array.isArray(bt))for(let Ct=0;Ct<bt.length;Ct++){let St=bt[Ct];qc(St,Y,N,W),G.add(St)}else qc(bt,Y,N,W),G.add(bt)}),T=g.pop(),O!==null&&O.renderEnd(),G},this.compileAsync=function(S,N,Y=null){let G=this.compile(S,N,Y);return new Promise(W=>{function bt(){if(G.forEach(function(Ct){let It=H.get(Ct).currentProgram;(It===void 0||It.isReady())&&G.delete(Ct)}),G.size===0){W(S);return}setTimeout(bt,10)}Yt.get("KHR_parallel_shader_compile")!==null?bt():setTimeout(bt,10)})};let ll=null;function Ad(S){ll&&ll(S)}function Yc(){Ei.stop()}function Zc(){Ei.start()}let Ei=new rd;Ei.setAnimationLoop(Ad),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(S){ll=S,Pt.setAnimationLoop(S),S===null?Ei.stop():Ei.start()},Pt.addEventListener("sessionstart",Yc),Pt.addEventListener("sessionend",Zc),this.render=function(S,N){if(N!==void 0&&N.isCamera!==!0){Xt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;O!==null&&O.renderStart(S,N);let Y=Pt.enabled===!0&&Pt.isPresenting===!0,G=A!==null&&(st===null||Y)&&A.begin(P,st);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),Pt.enabled===!0&&Pt.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(Pt.cameraAutoUpdate===!0&&Pt.updateCamera(N),N=Pt.getCamera()),S.isScene===!0&&S.onBeforeRender(P,S,N,st),T=lt.get(S,g.length),T.init(N),T.state.textureUnits=J.getTextureUnits(),g.push(T),pt.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),V.setFromProjectionMatrix(pt,xn,N.reversedDepth),ft=this.localClippingEnabled,q=At.init(this.clippingPlanes,ft),E=vt.get(S,b.length),E.init(),b.push(E),Pt.enabled===!0&&Pt.isPresenting===!0){let Ct=P.xr.getDepthSensingMesh();Ct!==null&&cl(Ct,N,-1/0,P.sortObjects)}cl(S,N,0,P.sortObjects),E.finish(),O!==null&&O.updateLights(T.state.lightsArray),P.sortObjects===!0&&E.sort(_t,Bt),Ot=Pt.enabled===!1||Pt.isPresenting===!1||Pt.hasDepthSensing()===!1,Ot&&Vt.addToRenderList(E,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),q===!0&&At.beginShadows();let W=T.state.shadowsArray;if(Dt.render(W,S,N),q===!0&&At.endShadows(),(G&&A.hasRenderPass())===!1){let Ct=E.opaque,St=E.transmissive;if(T.setupLights(),N.isArrayCamera){let It=N.cameras;if(St.length>0)for(let Ft=0,Kt=It.length;Ft<Kt;Ft++){let ee=It[Ft];$c(Ct,St,S,ee)}Ot&&Vt.render(S);for(let Ft=0,Kt=It.length;Ft<Kt;Ft++){let ee=It[Ft];Jc(E,S,ee,ee.viewport)}}else St.length>0&&$c(Ct,St,S,N),Ot&&Vt.render(S),Jc(E,S,N)}st!==null&&K===0&&(J.updateMultisampleRenderTarget(st),J.updateRenderTargetMipmap(st)),G&&A.end(P),S.isScene===!0&&S.onAfterRender(P,S,N),dt.resetDefaultState(),Z=-1,nt=null,g.pop(),g.length>0?(T=g[g.length-1],J.setTextureUnits(T.state.textureUnits),q===!0&&At.setGlobalState(P.clippingPlanes,T.state.camera)):T=null,b.pop(),b.length>0?E=b[b.length-1]:E=null,O!==null&&O.renderEnd()};function cl(S,N,Y,G){if(S.visible===!1)return;if(S.layers.test(N.layers)){if(S.isGroup)Y=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(N);else if(S.isLightProbeGrid)T.pushLightProbeGrid(S);else if(S.isLight)T.pushLight(S),S.castShadow&&T.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||S.intersectsFrustum(V)){G&&Ht.setFromMatrixPosition(S.matrixWorld).applyMatrix4(pt);let Ct=it.update(S),St=S.material;St.visible&&E.push(S,Ct,St,Y,Ht.z,null,N)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||S.intersectsFrustum(V))){let Ct=it.update(S),St=S.material;if(G&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ht.copy(S.boundingSphere.center)):(Ct.boundingSphere===null&&Ct.computeBoundingSphere(),Ht.copy(Ct.boundingSphere.center)),Ht.applyMatrix4(S.matrixWorld).applyMatrix4(pt)),Array.isArray(St)){let It=Ct.groups;for(let Ft=0,Kt=It.length;Ft<Kt;Ft++){let ee=It[Ft],Lt=St[ee.materialIndex];Lt&&Lt.visible&&E.push(S,Ct,Lt,Y,Ht.z,ee,N)}}else St.visible&&E.push(S,Ct,St,Y,Ht.z,null,N)}}let bt=S.children;for(let Ct=0,St=bt.length;Ct<St;Ct++)cl(bt[Ct],N,Y,G)}function Jc(S,N,Y,G){let{opaque:W,transmissive:bt,transparent:Ct}=S;T.setupLightsView(Y),q===!0&&At.setGlobalState(P.clippingPlanes,Y),G&&v.viewport(F.copy(G)),W.length>0&&Wr(W,N,Y),bt.length>0&&Wr(bt,N,Y),Ct.length>0&&Wr(Ct,N,Y),v.buffers.depth.setTest(!0),v.buffers.depth.setMask(!0),v.buffers.color.setMask(!0),v.setPolygonOffset(!1)}function $c(S,N,Y,G){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[G.id]===void 0){let Lt=Yt.has("EXT_color_buffer_half_float")||Yt.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[G.id]=new Ze(1,1,{generateMipmaps:!0,type:Lt?An:Je,minFilter:vi,samples:Math.max(4,R.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:ie.workingColorSpace})}let bt=T.state.transmissionRenderTarget[G.id],Ct=G.viewport||F;bt.setSize(Ct.z*P.transmissionResolutionScale,Ct.w*P.transmissionResolutionScale);let St=P.getRenderTarget(),It=P.getActiveCubeFace(),Ft=P.getActiveMipmapLevel();P.setRenderTarget(bt),P.getClearColor(Tt),ot=P.getClearAlpha(),ot<1&&P.setClearColor(16777215,.5),P.clear(),Ot&&Vt.render(Y);let Kt=P.toneMapping;P.toneMapping=Tn;let ee=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),T.setupLightsView(G),q===!0&&At.setGlobalState(P.clippingPlanes,G),Wr(S,Y,G),J.updateMultisampleRenderTarget(bt),J.updateRenderTargetMipmap(bt),Yt.has("WEBGL_multisampled_render_to_texture")===!1){let Lt=!1;for(let oe=0,Re=N.length;oe<Re;oe++){let _e=N[oe],{object:fe,geometry:Oe,material:Rt,group:ke}=_e;if(Rt.side===Ye&&fe.layers.test(G.layers)){let re=Rt.side;Rt.side=qe,Rt.needsUpdate=!0,Kc(fe,Y,G,Oe,Rt,ke),Rt.side=re,Rt.needsUpdate=!0,Lt=!0}}Lt===!0&&(J.updateMultisampleRenderTarget(bt),J.updateRenderTargetMipmap(bt))}P.setRenderTarget(St,It,Ft),P.setClearColor(Tt,ot),ee!==void 0&&(G.viewport=ee),P.toneMapping=Kt}function Wr(S,N,Y){let G=N.isScene===!0?N.overrideMaterial:null;for(let W=0,bt=S.length;W<bt;W++){let Ct=S[W],{object:St,geometry:It,group:Ft}=Ct,Kt=Ct.material;Kt.allowOverride===!0&&G!==null&&(Kt=G),St.layers.test(Y.layers)&&Kc(St,N,Y,It,Kt,Ft)}}function Kc(S,N,Y,G,W,bt){O!==null&&W.isNodeMaterial&&O.setObject(S,W),S.onBeforeRender(P,N,Y,G,W,bt),S.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),W.onBeforeRender(P,N,Y,G,S,bt),W.transparent===!0&&W.side===Ye&&W.forceSinglePass===!1?(W.side=qe,W.needsUpdate=!0,P.renderBufferDirect(Y,N,G,W,S,bt),W.side=gi,W.needsUpdate=!0,P.renderBufferDirect(Y,N,G,W,S,bt),W.side=Ye):P.renderBufferDirect(Y,N,G,W,S,bt),S.onAfterRender(P,N,Y,G,W,bt)}function Xr(S,N,Y){N.isScene!==!0&&(N=Jt);let G=H.get(S),W=T.state.lights,bt=T.state.shadowsArray,Ct=W.state.version,St=xt.getParameters(S,W.state,bt,N,Y,T.state.lightProbeGridArray),It=xt.getProgramCacheKey(St),Ft=G.programs;G.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?N.environment:null,G.fog=N.fog;let Kt=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;G.envMap=ct.get(S.envMap||G.environment,Kt),G.envMapRotation=G.environment!==null&&S.envMap===null?N.environmentRotation:S.envMapRotation,Ft===void 0&&(S.addEventListener("dispose",Cn),Ft=new Map,G.programs=Ft);let ee=Ft.get(It);if(ee!==void 0){if(G.currentProgram===ee&&G.lightsStateVersion===Ct)return jc(S,St),ee}else St.uniforms=xt.getUniforms(S),O!==null&&S.isNodeMaterial&&O.build(S,Y,St),S.onBeforeCompile(St,P),ee=xt.acquireProgram(St,It),Ft.set(It,ee),G.uniforms=St.uniforms;let Lt=G.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Lt.clippingPlanes=At.uniform),jc(S,St),G.needsLights=Id(S),G.lightsStateVersion=Ct,G.needsLights&&(Lt.ambientLightColor.value=W.state.ambient,Lt.lightProbe.value=W.state.probe,Lt.sunLights.value=W.state.sun,Lt.sunLightShadows.value=W.state.sunShadow,Lt.directionalLights.value=W.state.directional,Lt.directionalLightShadows.value=W.state.directionalShadow,Lt.spotLights.value=W.state.spot,Lt.spotLightShadows.value=W.state.spotShadow,Lt.rectAreaLights.value=W.state.rectArea,Lt.ltc_1.value=W.state.rectAreaLTC1,Lt.ltc_2.value=W.state.rectAreaLTC2,Lt.pointLights.value=W.state.point,Lt.pointLightShadows.value=W.state.pointShadow,Lt.hemisphereLights.value=W.state.hemi,Lt.sunShadowMatrix.value=W.state.sunShadowMatrix,Lt.sunShadowCascade.value=W.state.sunShadowCascade,Lt.directionalShadowMatrix.value=W.state.directionalShadowMatrix,Lt.spotLightMatrix.value=W.state.spotLightMatrix,Lt.spotLightMap.value=W.state.spotLightMap,Lt.pointShadowMatrix.value=W.state.pointShadowMatrix),G.lightProbeGrid=T.state.lightProbeGridArray.length>0,G.currentProgram=ee,G.uniformsList=null,ee}function Qc(S){if(S.uniformsList===null){let N=S.currentProgram.getUniforms();S.uniformsList=Cs.seqWithValue(N.seq,S.uniforms)}return S.uniformsList}function jc(S,N){let Y=H.get(S);Y.outputColorSpace=N.outputColorSpace,Y.batching=N.batching,Y.batchingColor=N.batchingColor,Y.instancing=N.instancing,Y.instancingColor=N.instancingColor,Y.instancingMorph=N.instancingMorph,Y.skinning=N.skinning,Y.morphTargets=N.morphTargets,Y.morphNormals=N.morphNormals,Y.morphColors=N.morphColors,Y.morphTargetsCount=N.morphTargetsCount,Y.numClippingPlanes=N.numClippingPlanes,Y.numIntersection=N.numClipIntersection,Y.vertexAlphas=N.vertexAlphas,Y.vertexTangents=N.vertexTangents,Y.toneMapping=N.toneMapping}function Rd(S,N){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;x.setFromMatrixPosition(N.matrixWorld);for(let Y=0,G=S.length;Y<G;Y++){let W=S[Y];if(W.texture!==null&&W.boundingBox.containsPoint(x))return W}return null}function Cd(S,N,Y,G,W){N.isScene!==!0&&(N=Jt),J.resetTextureUnits();let bt=N.fog,Ct=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?N.environment:null,St=st===null?P.outputColorSpace:st.isXRRenderTarget===!0?st.texture.colorSpace:ie.workingColorSpace,It=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Ft=ct.get(G.envMap||Ct,It),Kt=G.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,ee=!!Y.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Lt=!!Y.morphAttributes.position,oe=!!Y.morphAttributes.normal,Re=!!Y.morphAttributes.color,_e=Tn;G.toneMapped&&(st===null||st.isXRRenderTarget===!0)&&(_e=P.toneMapping);let fe=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,Oe=fe!==void 0?fe.length:0,Rt=H.get(G),ke=T.state.lights;if(q===!0&&(ft===!0||S!==nt)){let ge=S===nt&&G.id===Z;At.setState(G,S,ge)}let re=!1;G.version===Rt.__version?(Rt.needsLights&&Rt.lightsStateVersion!==ke.state.version||Rt.outputColorSpace!==St||W.isBatchedMesh&&Rt.batching===!1||!W.isBatchedMesh&&Rt.batching===!0||W.isBatchedMesh&&Rt.batchingColor===!0&&W._colorsTexture===null||W.isBatchedMesh&&Rt.batchingColor===!1&&W._colorsTexture!==null||W.isInstancedMesh&&Rt.instancing===!1||!W.isInstancedMesh&&Rt.instancing===!0||W.isSkinnedMesh&&Rt.skinning===!1||!W.isSkinnedMesh&&Rt.skinning===!0||W.isInstancedMesh&&Rt.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&Rt.instancingColor===!1&&W.instanceColor!==null||W.isInstancedMesh&&Rt.instancingMorph===!0&&W.morphTexture===null||W.isInstancedMesh&&Rt.instancingMorph===!1&&W.morphTexture!==null||Rt.envMap!==Ft||G.fog===!0&&Rt.fog!==bt||Rt.numClippingPlanes!==void 0&&(Rt.numClippingPlanes!==At.numPlanes||Rt.numIntersection!==At.numIntersection)||Rt.vertexAlphas!==Kt||Rt.vertexTangents!==ee||Rt.morphTargets!==Lt||Rt.morphNormals!==oe||Rt.morphColors!==Re||Rt.toneMapping!==_e||Rt.morphTargetsCount!==Oe||!!Rt.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(re=!0):(re=!0,Rt.__version=G.version);let rn=Rt.currentProgram;re===!0&&(rn=Xr(G,N,W),O&&G.isNodeMaterial&&O.onUpdateProgram(G,rn,Rt));let Pn=!1,ti=!1,Hi=!1,ue=rn.getUniforms(),Te=Rt.uniforms;if(v.useProgram(rn.program)&&(Pn=!0,ti=!0,Hi=!0),G.id!==Z&&(Z=G.id,ti=!0),Rt.needsLights){let ge=Rd(T.state.lightProbeGridArray,W);Rt.lightProbeGrid!==ge&&(Rt.lightProbeGrid=ge,ti=!0)}if(Pn||nt!==S){v.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ue.setValue(I,"projectionMatrix",S.projectionMatrix),ue.setValue(I,"viewMatrix",S.matrixWorldInverse);let ni=ue.map.cameraPosition;ni!==void 0&&ni.setValue(I,Et.setFromMatrixPosition(S.matrixWorld)),R.logarithmicDepthBuffer&&ue.setValue(I,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&ue.setValue(I,"isOrthographic",S.isOrthographicCamera===!0),nt!==S&&(nt=S,ti=!0,Hi=!0)}if(Rt.needsLights&&(ke.state.sunShadowMap.length>0&&ue.setValue(I,"sunShadowMap",ke.state.sunShadowMap,J),ke.state.directionalShadowMap.length>0&&ue.setValue(I,"directionalShadowMap",ke.state.directionalShadowMap,J),ke.state.spotShadowMap.length>0&&ue.setValue(I,"spotShadowMap",ke.state.spotShadowMap,J),ke.state.pointShadowMap.length>0&&ue.setValue(I,"pointShadowMap",ke.state.pointShadowMap,J)),W.isSkinnedMesh){ue.setOptional(I,W,"bindMatrix"),ue.setOptional(I,W,"bindMatrixInverse");let ge=W.skeleton;ge&&(ge.boneTexture===null&&ge.computeBoneTexture(),ue.setValue(I,"boneTexture",ge.boneTexture,J))}W.isBatchedMesh&&(ue.setOptional(I,W,"batchingTexture"),ue.setValue(I,"batchingTexture",W._matricesTexture,J),ue.setOptional(I,W,"batchingIdTexture"),ue.setValue(I,"batchingIdTexture",W._indirectTexture,J),ue.setOptional(I,W,"batchingColorTexture"),W._colorsTexture!==null&&ue.setValue(I,"batchingColorTexture",W._colorsTexture,J));let ei=Y.morphAttributes;if((ei.position!==void 0||ei.normal!==void 0||ei.color!==void 0)&&D.update(W,Y,rn),(ti||Rt.receiveShadow!==W.receiveShadow)&&(Rt.receiveShadow=W.receiveShadow,ue.setValue(I,"receiveShadow",W.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&N.environment!==null&&(Te.envMapIntensity.value=N.environmentIntensity),Te.dfgLUT!==void 0&&(Te.dfgLUT.value=X_()),ti){if(ue.setValue(I,"toneMappingExposure",P.toneMappingExposure),Rt.needsLights&&Pd(Te,Hi),bt&&G.fog===!0&&Nt.refreshFogUniforms(Te,bt),Nt.refreshMaterialUniforms(Te,G,j,k,T.state.transmissionRenderTarget[S.id]),Rt.needsLights&&Rt.lightProbeGrid){let ge=Rt.lightProbeGrid;Te.probesSH.value=ge.texture,Te.probesMin.value.copy(ge.boundingBox.min),Te.probesMax.value.copy(ge.boundingBox.max),Te.probesResolution.value.copy(ge.resolution)}Cs.upload(I,Qc(Rt),Te,J)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Cs.upload(I,Qc(Rt),Te,J),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&ue.setValue(I,"center",W.center),ue.setValue(I,"modelViewMatrix",W.modelViewMatrix),ue.setValue(I,"normalMatrix",W.normalMatrix),ue.setValue(I,"modelMatrix",W.matrixWorld),G.uniformsGroups!==void 0){let ge=G.uniformsGroups;for(let ni=0,Vi=ge.length;ni<Vi;ni++){let eh=ge[ni];rt.update(eh,rn),rt.bind(eh,rn)}}return rn}function Pd(S,N){S.ambientLightColor.needsUpdate=N,S.lightProbe.needsUpdate=N,S.sunLights.needsUpdate=N,S.sunLightShadows.needsUpdate=N,S.directionalLights.needsUpdate=N,S.directionalLightShadows.needsUpdate=N,S.pointLights.needsUpdate=N,S.pointLightShadows.needsUpdate=N,S.spotLights.needsUpdate=N,S.spotLightShadows.needsUpdate=N,S.rectAreaLights.needsUpdate=N,S.hemisphereLights.needsUpdate=N}function Id(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return $},this.getActiveMipmapLevel=function(){return K},this.getRenderTarget=function(){return st},this.setRenderTargetTextures=function(S,N,Y){let G=H.get(S);G.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),H.get(S.texture).__webglTexture=N,H.get(S.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:Y,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,N){let Y=H.get(S);Y.__webglFramebuffer=N,Y.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(S,N=0,Y=0){st=S,$=N,K=Y;let G=null,W=!1,bt=!1;if(S){let St=H.get(S);if(St.__useDefaultFramebuffer!==void 0){v.bindFramebuffer(I.FRAMEBUFFER,St.__webglFramebuffer),F.copy(S.viewport),at.copy(S.scissor),et=S.scissorTest,v.viewport(F),v.scissor(at),v.setScissorTest(et),Z=-1;return}else if(St.__webglFramebuffer===void 0)J.setupRenderTarget(S);else if(St.__hasExternalTextures)J.rebindTextures(S,H.get(S.texture).__webglTexture,H.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){let Kt=S.depthTexture;if(St.__boundDepthTexture!==Kt){if(Kt!==null&&H.has(Kt)&&(S.width!==Kt.image.width||S.height!==Kt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(S)}}let It=S.texture;(It.isData3DTexture||It.isDataArrayTexture||It.isCompressedArrayTexture)&&(bt=!0);let Ft=H.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ft[N])?G=Ft[N][Y]:G=Ft[N],W=!0):S.samples>0&&J.useMultisampledRTT(S)===!1?G=H.get(S).__webglMultisampledFramebuffer:Array.isArray(Ft)?G=Ft[Y]:G=Ft,F.copy(S.viewport),at.copy(S.scissor),et=S.scissorTest}else F.copy(yt).multiplyScalar(j).floor(),at.copy(kt).multiplyScalar(j).floor(),et=ye;if(Y!==0&&(G=X),v.bindFramebuffer(I.FRAMEBUFFER,G)&&v.drawBuffers(S,G),v.viewport(F),v.scissor(at),v.setScissorTest(et),W){let St=H.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+N,St.__webglTexture,Y)}else if(bt){let St=N;for(let It=0;It<S.textures.length;It++){let Ft=H.get(S.textures[It]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+It,Ft.__webglTexture,Y,St)}}else if(S!==null&&Y!==0){let St=H.get(S.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,St.__webglTexture,Y)}Z=-1};function th(S){let N=H.get(S);return(N.__readFormat!==S.format||N.__readType!==S.type)&&(N.__readFormat=S.format,N.__readType=S.type,N.__formatReadable=R.textureFormatReadable(S.format),N.__typeReadable=R.textureTypeReadable(S.type)),N}this.readRenderTargetPixels=function(S,N,Y,G,W,bt,Ct,St=0){if(!(S&&S.isWebGLRenderTarget)){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let It=H.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ct!==void 0&&(It=It[Ct]),It){v.bindFramebuffer(I.FRAMEBUFFER,It);try{let Ft=S.textures[St],Kt=Ft.format,ee=Ft.type;S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+St);let Lt=th(Ft);if(Lt.__formatReadable===!1){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(Lt.__typeReadable===!1){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=S.width-G&&Y>=0&&Y<=S.height-W&&I.readPixels(N,Y,G,W,ht.convert(Kt),ht.convert(ee),bt)}finally{let Ft=st!==null?H.get(st).__webglFramebuffer:null;v.bindFramebuffer(I.FRAMEBUFFER,Ft)}}},this.readRenderTargetPixelsAsync=async function(S,N,Y,G,W,bt,Ct,St=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let It=H.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Ct!==void 0&&(It=It[Ct]),It)if(N>=0&&N<=S.width-G&&Y>=0&&Y<=S.height-W){v.bindFramebuffer(I.FRAMEBUFFER,It);let Ft=S.textures[St],Kt=Ft.format,ee=Ft.type;S.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+St);let Lt=th(Ft);if(Lt.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(Lt.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let oe=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,oe),I.bufferData(I.PIXEL_PACK_BUFFER,bt.byteLength,I.STREAM_READ),I.readPixels(N,Y,G,W,ht.convert(Kt),ht.convert(ee),0),I.bindBuffer(I.PIXEL_PACK_BUFFER,null);let Re=st!==null?H.get(st).__webglFramebuffer:null;v.bindFramebuffer(I.FRAMEBUFFER,Re);let _e=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await Au(I,_e,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,oe),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,bt),I.bindBuffer(I.PIXEL_PACK_BUFFER,null),I.deleteBuffer(oe),I.deleteSync(_e),bt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,N=null,Y=0){let G=Math.pow(2,-Y),W=Math.floor(S.image.width*G),bt=Math.floor(S.image.height*G),Ct=N!==null?N.x:0,St=N!==null?N.y:0;J.setTexture2D(S,0),I.copyTexSubImage2D(I.TEXTURE_2D,Y,0,0,Ct,St,W,bt),v.unbindTexture()},this.copyTextureToTexture=function(S,N,Y=null,G=null,W=0,bt=0){let Ct,St,It,Ft,Kt,ee,Lt,oe,Re,_e=S.isCompressedTexture?S.mipmaps[bt]:S.image;if(Y!==null)Ct=Y.max.x-Y.min.x,St=Y.max.y-Y.min.y,It=Y.isBox3?Y.max.z-Y.min.z:1,Ft=Y.min.x,Kt=Y.min.y,ee=Y.isBox3?Y.min.z:0;else{let Te=Math.pow(2,-W);Ct=Math.floor(_e.width*Te),St=Math.floor(_e.height*Te),S.isDataArrayTexture?It=_e.depth:S.isData3DTexture?It=Math.floor(_e.depth*Te):It=1,Ft=0,Kt=0,ee=0}G!==null?(Lt=G.x,oe=G.y,Re=G.z):(Lt=0,oe=0,Re=0);let fe=ht.convert(N.format),Oe=ht.convert(N.type),Rt;N.isData3DTexture?(J.setTexture3D(N,0),Rt=I.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(J.setTexture2DArray(N,0),Rt=I.TEXTURE_2D_ARRAY):(J.setTexture2D(N,0),Rt=I.TEXTURE_2D),v.activeTexture(I.TEXTURE0),v.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,N.flipY),v.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),v.pixelStorei(I.UNPACK_ALIGNMENT,N.unpackAlignment);let ke=v.getParameter(I.UNPACK_ROW_LENGTH),re=v.getParameter(I.UNPACK_IMAGE_HEIGHT),rn=v.getParameter(I.UNPACK_SKIP_PIXELS),Pn=v.getParameter(I.UNPACK_SKIP_ROWS),ti=v.getParameter(I.UNPACK_SKIP_IMAGES);v.pixelStorei(I.UNPACK_ROW_LENGTH,_e.width),v.pixelStorei(I.UNPACK_IMAGE_HEIGHT,_e.height),v.pixelStorei(I.UNPACK_SKIP_PIXELS,Ft),v.pixelStorei(I.UNPACK_SKIP_ROWS,Kt),v.pixelStorei(I.UNPACK_SKIP_IMAGES,ee);let Hi=S.isDataArrayTexture||S.isData3DTexture,ue=N.isDataArrayTexture||N.isData3DTexture;if(S.isDepthTexture){let Te=H.get(S),ei=H.get(N),ge=H.get(Te.__renderTarget),ni=H.get(ei.__renderTarget);v.bindFramebuffer(I.READ_FRAMEBUFFER,ge.__webglFramebuffer),v.bindFramebuffer(I.DRAW_FRAMEBUFFER,ni.__webglFramebuffer);for(let Vi=0;Vi<It;Vi++)Hi&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,H.get(S).__webglTexture,W,ee+Vi),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,H.get(N).__webglTexture,bt,Re+Vi)),I.blitFramebuffer(Ft,Kt,Ct,St,Lt,oe,Ct,St,I.DEPTH_BUFFER_BIT,I.NEAREST);v.bindFramebuffer(I.READ_FRAMEBUFFER,null),v.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(W!==0||S.isRenderTargetTexture||H.has(S)){let Te=H.get(S),ei=H.get(N);v.bindFramebuffer(I.READ_FRAMEBUFFER,L),v.bindFramebuffer(I.DRAW_FRAMEBUFFER,z);for(let ge=0;ge<It;ge++)Hi?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Te.__webglTexture,W,ee+ge):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Te.__webglTexture,W),ue?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,ei.__webglTexture,bt,Re+ge):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,ei.__webglTexture,bt),W!==0?I.blitFramebuffer(Ft,Kt,Ct,St,Lt,oe,Ct,St,I.COLOR_BUFFER_BIT,I.NEAREST):ue?I.copyTexSubImage3D(Rt,bt,Lt,oe,Re+ge,Ft,Kt,Ct,St):I.copyTexSubImage2D(Rt,bt,Lt,oe,Ft,Kt,Ct,St);v.bindFramebuffer(I.READ_FRAMEBUFFER,null),v.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else ue?S.isDataTexture||S.isData3DTexture?I.texSubImage3D(Rt,bt,Lt,oe,Re,Ct,St,It,fe,Oe,_e.data):N.isCompressedArrayTexture?I.compressedTexSubImage3D(Rt,bt,Lt,oe,Re,Ct,St,It,fe,_e.data):I.texSubImage3D(Rt,bt,Lt,oe,Re,Ct,St,It,fe,Oe,_e):S.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,bt,Lt,oe,Ct,St,fe,Oe,_e.data):S.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,bt,Lt,oe,_e.width,_e.height,fe,_e.data):I.texSubImage2D(I.TEXTURE_2D,bt,Lt,oe,Ct,St,fe,Oe,_e);v.pixelStorei(I.UNPACK_ROW_LENGTH,ke),v.pixelStorei(I.UNPACK_IMAGE_HEIGHT,re),v.pixelStorei(I.UNPACK_SKIP_PIXELS,rn),v.pixelStorei(I.UNPACK_SKIP_ROWS,Pn),v.pixelStorei(I.UNPACK_SKIP_IMAGES,ti),bt===0&&N.generateMipmaps&&I.generateMipmap(Rt),v.unbindTexture()},this.initRenderTarget=function(S){H.get(S).__webglFramebuffer===void 0&&J.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?J.setTextureCube(S,0):S.isData3DTexture?J.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?J.setTexture2DArray(S,0):J.setTexture2D(S,0),v.unbindTexture()},this.resetState=function(){$=0,K=0,st=null,v.reset(),dt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return xn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=ie._getDrawingBufferColorSpace(t),e.unpackColorSpace=ie._getUnpackColorSpace()}};var Ee=i=>{let t=Math.sin(i*127.1+311.7)*43758.5453;return t-Math.floor(t)},Hc="float windField(float t,float x){return 0.65+0.35*sin(t*1.15+x*.006);}",Vc=(i,t)=>.65+.35*Math.sin(i*1.15+t*.006),dd={value:0},q_=new Mr(1,1),Y_=new hi(.6,1,1,7),Z_=new Fe({color:3162684,roughness:1}),fd=new Fe({roughness:1});fd.onBeforeCompile=i=>{i.uniforms.forestTime=dd,i.vertexShader=`uniform float forestTime;
`+Hc+`
`+i.vertexShader,i.vertexShader=i.vertexShader.replace("#include <project_vertex>",`
    ...
    gl_Position=projectionMatrix*mvPosition;
  `)};function kc(i,t,e){let n=new te;n.scale.setScalar(t),i.add(n);function s(l,c,h){let f=new C(...l),u=new C(...c),d=new se(Y_,Z_);d.position.copy(f).add(u).multiplyScalar(.5),d.scale.set(h,f.distanceTo(u),h),d.quaternion.setFromUnitVectors(new C(0,1,0),u.sub(f).normalize()),n.add(d)}s([0,0,0],[2,63,0],3.3);for(let l=0;l<5;l++){let c=l%2?1:-1,h=29+l*6;s([1,h,0],[c*(12+Ee(e+l)*7),h+18,(Ee(e+l*2)-.5)*10],1.1)}let r=new gs(q_,fd,19),a=new Se,o=new Gt;for(let l=0;l<19;l++){let c=Math.floor(l/6),h=l*2.399+e,f=c===3?0:19-c*4;a.position.set(Math.cos(h)*f,49+c*12+(Ee(e+l)-.5)*8,Math.sin(h)*f*.6),a.scale.set(12+Ee(e+l*3)*7,12+Ee(e+l*7)*8,10+Ee(e+l*5)*6),a.rotation.set(Ee(e+l),h,Ee(e+l*9)*.4),a.updateMatrix(),r.setMatrixAt(l,a.matrix),o.setHSL(.39+Ee(e)*.07,.23+Ee(e+l)*.16,.17+Ee(e+l*4)*.085+c*.014),r.setColorAt(l,o)}return r.frustumCulled=!1,n.add(r),n}function pd(i){let t=new te;i.add(t);let e=new vs;e.moveTo(-1,0),e.quadraticCurveTo(0,.85,1,0),e.quadraticCurveTo(0,-.7,-1,0);let n=new gs(new Sr(e),new je({color:16777215,side:Ye,transparent:!0,opacity:.65,depthWrite:!1}),64);n.frustumCulled=!1,t.add(n);let s=new Se,r=new Gt;for(let _=0;_<64;_++)r.set(_%4===0?12166762:_%3===0?10272121:6856059),n.setColorAt(_,r);let a=new Float32Array(540),o=new ne().setAttribute("position",new de(a,3)),l=new Sn(o,new ln({color:13032624,size:2,transparent:!0,opacity:.43,depthWrite:!1,sizeAttenuation:!1}));l.frustumCulled=!1,t.add(l);let c=new Float32Array(720),h=new Float32Array(c.length),f=new ne().setAttribute("position",new de(c,3)).setAttribute("color",new de(h,3)),u=new li(f,new Kn({vertexColors:!0,transparent:!0,opacity:.2,depthWrite:!1,blending:hn}));u.frustumCulled=!1,t.add(u);let d=(_,M)=>M-350+((_-(M-350))%2300+2300)%2300;return{update(_,M,m=!1){n.count=m?16:64,l.visible=!m,u.visible=!m,dd.value=_;let p=-(_*62-15*Math.cos(_*1.15));for(let y=0;y<n.count;y++){let w=d(Ee(y*3)*2300+p*(.65+Ee(y)*.6),M),x=_*1.7+y*2.4;s.position.set(w,110+Ee(y*7)*710+Math.sin(x*.57)*28+Math.sin(w*.009+_)*12,-150+Ee(y*13)*235),s.rotation.set(x,Math.sin(x*.8)*.7,-.3+Math.sin(x*.63)*.8);let E=3+Ee(y*17)*3;s.scale.set(E,E*.7,1),s.updateMatrix(),n.setMatrixAt(y,s.matrix)}n.instanceMatrix.needsUpdate=!0;for(let y=0;y<(m?0:180);y++)a.set([d(Ee(y*5)*2300+p*(.8+Ee(y)*.6),M),60+Ee(y*9)*850+Math.sin(_*1.3+y)*16,-240+Ee(y*11)*320],y*3);o.attributes.position.needsUpdate=!0;for(let y=0;y<(m?0:12);y++){let w=d(Ee(y*21)*2300+p*1.4,M),x=170+Ee(y*23)*610,E=Vc(_,w);for(let T=0;T<10;T++)for(let b=0;b<2;b++){let g=(T+b)/10,A=(y*20+T*2+b)*3;c.set([w+g*95,x+Math.sin(g*2.5+_*.8+y)*9,-110],A);let P=Math.sin(g*Math.PI)*E*.65;h.set([P*.64,P*.83,P*.73],A)}}f.attributes.position.needsUpdate=!0,f.attributes.color.needsUpdate=!0}}}function md(i){let t=new te,e=new te,n=new te;t.add(e,n);function s(x,E,T,b=1,g=i,A=!0){let P=new $n(new Fn({map:g,color:E,transparent:!0,opacity:b,depthWrite:!1,blending:A?hn:_i}));return P.scale.set(T,T,1),x.add(P),P}function r(x){let E=document.createElement("canvas");E.width=E.height=128,x(E.getContext("2d"));let T=new bn(E);return T.colorSpace=we,T}let a=s(e,16759635,172,.62),o=s(e,16771760,78,1),l=s(e,16774351,49,.85);l.position.set(-2,3,1);let c=Array.from({length:5},(x,E)=>s(e,E%2?16766080:16760150,48,.28)),h=r(x=>{x.fillStyle="#513426",x.beginPath(),x.ellipse(64,64,30,40,0,0,Math.PI*2),x.fill(),x.fillStyle="#fff8de",x.beginPath(),x.ellipse(54,48,10,12,0,0,Math.PI*2),x.fill(),x.globalAlpha=.55,x.beginPath(),x.arc(73,79,5,0,Math.PI*2),x.fill()}),f=[-1,1].map(x=>{let E=s(n,16777215,10,1,h,!1);return E.position.set(x*5.5,1,22),E}),u=r(x=>{x.strokeStyle="#815039",x.lineWidth=9,x.lineCap="round",x.beginPath(),x.moveTo(33,51),x.quadraticCurveTo(64,86,95,51),x.stroke()}),d=s(n,16777215,9,.9,u,!1);d.position.set(0,-5,23);let _=[-1,1].map(x=>{let E=s(n,16750205,14,.48,i,!1);return E.position.set(x*10,-4,21),E}),M=Array.from({length:9},()=>s(t,16769696,6,.6)),m=new Rr(16764533,13e3,280,1.6);t.add(m);let p,y=0,w=0;return{root:t,update(x,E,T,b){let g=p===void 0?0:x-p,A=Math.max(0,Math.min(g,.05));p=x,(g<0||g>.25)&&(y=0,w=0);let P=Vc(x,E.x),U=E.vx||0,O=E.vy||0,X=Math.min(Math.hypot(U,O)/320,1),L=be.clamp(-U*.001-P*.12+Math.sin(x*1.9)*.055,-.3,.3),z=A;for(;z>0;){let et=Math.min(z,.008333333333333333);w+=((L-y)*32-w*7)*et,y+=w*et,z-=et}t.position.set(E.x,900-E.y,E.z??55),n.rotation.z=y;let $=Math.sin(x*2.4)*.045;o.scale.set(78*(1+$+X*.12),78*(1-$-X*.06),1),a.scale.set(172+P*16,166+Math.sin(x*1.6)*10,1),a.material.opacity=.56+Math.sin(x*2.4)*.06,l.position.set(Math.sin(x*1.7)*2,3+Math.cos(x*2.1)*2,1);for(let et=0;et<c.length;et++){let Tt=(et+1)/c.length,ot=x*(1.7+Tt*.3)+et*1.6;c[et].position.set((-U*.075-P*22)*Tt+Math.sin(ot)*5,(O*.06+12)*Tt+Math.cos(ot)*6,-2-et),c[et].scale.set(48-Tt*18+P*9,42-Tt*12,1),c[et].material.opacity=(1-Tt*.7)*(.26+Math.sin(ot)*.035)}let K=be.clamp((T.x-E.x)*.022,-2.5,2.5),st=be.clamp((E.y-T.y-20)*.015,-1.3,1.3),Z=x%5.7,nt=Math.max(0,1-Math.abs(Z-4.6)/.11,.85*(1-Math.abs(Z-4.88)/.08));f.forEach((et,Tt)=>{et.position.set((Tt?5.5:-5.5)+K,1+st,22),et.scale.set(10,10*(1-nt*.9),1)});let F=b==="PUNTO";d.scale.y=F?9+Math.sin(x*13)*2:9,d.position.x=K*.65,_.forEach(et=>et.material.opacity=.42+Math.sin(x*2.4)*.06),M.forEach((et,Tt)=>{let ot=(x*.3+Tt/9)%1,wt=Tt*2.399;et.position.set(Math.cos(wt)*(17+ot*19)-P*ot*26-U*.09*ot,Math.sin(wt)*13+ot*38+O*.06*ot,-4),et.material.opacity=Math.sin(ot*Math.PI)*.55,et.scale.setScalar(3+Math.sin(ot*Math.PI)*3)});let at=E.magic||0;a.scale.multiplyScalar(1+at*.4),a.material.opacity+=at*.2,c.forEach((et,Tt)=>{at&&et.position.set(Math.cos(x*4+Tt*1.26)*32,Math.sin(x*4+Tt*1.26)*25,-2-Tt)}),m.intensity=13e3*(1+Math.sin(x*2.4)*.06+at*.7)}}}var Vr=new C;function un(i,t,e,n,s,r){let a=2*Math.PI*s/4,o=Math.max(r-2*s,0),l=Math.PI/4;Vr.copy(t),Vr[n]=0,Vr.normalize();let c=.5*a/(a+o),h=1-Vr.angleTo(i)/l;return Math.sign(Vr[e])===1?h*c:o/(a+o)+c+c*(1-h)}var Ls=class i extends cn{constructor(t=1,e=1,n=1,s=2,r=.1){let a=s*2+1;if(r=Math.min(t/2,e/2,n/2,r),super(1,1,1,a,a,a),this.type="RoundedBoxGeometry",this.parameters={width:t,height:e,depth:n,segments:s,radius:r},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let l=new C,c=new C,h=new C(t,e,n).divideScalar(2).subScalar(r),f=this.attributes.position.array,u=this.attributes.normal.array,d=this.attributes.uv.array,_=f.length/6,M=new C,m=.5/a;for(let p=0,y=0;p<f.length;p+=3,y+=2)switch(l.fromArray(f,p),c.copy(l),c.x-=Math.sign(c.x)*m,c.y-=Math.sign(c.y)*m,c.z-=Math.sign(c.z)*m,c.normalize(),f[p+0]=h.x*Math.sign(l.x)+c.x*r,f[p+1]=h.y*Math.sign(l.y)+c.y*r,f[p+2]=h.z*Math.sign(l.z)+c.z*r,u[p+0]=c.x,u[p+1]=c.y,u[p+2]=c.z,Math.floor(p/_)){case 0:M.set(1,0,0),d[y+0]=un(M,c,"z","y",r,n),d[y+1]=1-un(M,c,"y","z",r,e);break;case 1:M.set(-1,0,0),d[y+0]=1-un(M,c,"z","y",r,n),d[y+1]=1-un(M,c,"y","z",r,e);break;case 2:M.set(0,1,0),d[y+0]=1-un(M,c,"x","z",r,t),d[y+1]=un(M,c,"z","x",r,n);break;case 3:M.set(0,-1,0),d[y+0]=1-un(M,c,"x","z",r,t),d[y+1]=1-un(M,c,"z","x",r,n);break;case 4:M.set(0,0,1),d[y+0]=1-un(M,c,"x","y",r,t),d[y+1]=1-un(M,c,"y","x",r,e);break;case 5:M.set(0,0,-1),d[y+0]=un(M,c,"x","y",r,t),d[y+1]=1-un(M,c,"y","x",r,e);break}}static fromJSON(t){return new i(t.width,t.height,t.depth,t.segments,t.radius)}};var Si=be.clamp,Rn=be.lerp,J_=new di(1,28,20),gd=i=>Math.atan2(Math.sin(i),Math.cos(i));function _d(){let i=new te,t=new te,e=new te,n=new te;i.name="boy",t.name="hips",e.name="torso",n.name="head",i.add(t),t.add(e),e.add(n),t.position.y=28,n.position.y=27;let s={};for(let[V,q]of Object.entries({skin:15971742,ear:14650754,hair:4335646,lock:5320997,highlight:7358521,sweater:6323098,rib:5336199,seam:9150903,pants:4277332,shoe:8754078,sole:14010805,white:16774631,mouth:8932674}))s[V]=new Fe({color:q,roughness:1,emissive:q,emissiveIntensity:V==="skin"?.16:.055});function r(V,q,ft,pt,Et,Ht,Jt=1,Ot=1,Zt=1){let I=new se(q,typeof ft=="string"?s[ft]:ft);return I.position.set(pt,Et,Ht),I.scale.set(Jt,Ot,Zt),I.castShadow=!0,I.receiveShadow=!1,V.add(I),I}let a=(V,q,ft,pt,Et,Ht,Jt,Ot)=>r(V,J_,Ot,q,ft,pt,Et,Ht,Jt),o=(V,q,ft,pt,Et,Ht,Jt,Ot,Zt)=>r(V,new Ls(Et,Ht,Jt,3,Ot),Zt,q,ft,pt);function l(V,q,ft,pt,Et){let Ht=new te;return Ht.position.set(q,ft,pt),Ht.name=Et,V.add(Ht),Ht}function c(V,q,ft,pt){return r(V,new br(new ui(q.map(Et=>new C(...Et))),20,ft,6,!1),pt,0,0,0)}function h(V){let q=document.createElement("canvas");q.width=512,q.height=256,V(q.getContext("2d"));let ft=new bn(q);return ft.colorSpace=we,new Fe({map:ft,transparent:!0,depthWrite:!1,roughness:1})}function f(V){return new ui(V.map(([q,ft])=>new C(ft,q,0))).getPoints(48).map(q=>new ut(Math.max(0,q.x),q.y))}let u=f([[0,0],[0,12.5],[2,14.5],[8,16],[17,15.8],[22,13.5],[25,9],[26,6]]);r(e,new Ms(u,40),"sweater",0,0,0,1,1,.76);function d(V,q,ft,pt,Et=1){let Ht=r(V,new On(ft,pt,10,40),"rib",0,q,0,1,Et,1);return Ht.rotation.x=Math.PI/2,Ht}d(e,1.6,13.9,1.5,.76),a(e,0,26,0,5.7,7,5.8,"skin");let _=r(e,new On(6.2,1.5,8,32),"rib",0,25,0);_.rotation.x=Math.PI/2;for(let V of[-1,1])c(e,[[V*7,24,6],[V*11,22,7.5],[V*13,19,7.5]],.16,"seam");let M=h(V=>{V.fillStyle="#e5edf0",V.textAlign="center",V.textBaseline="middle",V.font="bold 112px cursive",V.fillText("Bluey",256,155),V.save(),V.translate(249,49),V.rotate(-.15),V.beginPath(),V.ellipse(-19,0,12,30,0,0,Math.PI*2),V.ellipse(16,0,12,29,0,0,Math.PI*2),V.fill(),V.fillStyle="#689ab6",V.beginPath(),V.ellipse(-19,0,5,20,0,0,Math.PI*2),V.fill(),V.restore()}),m=new En(23,11.5,24,12),p=m.attributes.position;for(let V=0;V<p.count;V++){let q=p.getY(V)+15,ft=0;for(let pt=1;pt<u.length;pt++){let Et=u[pt-1],Ht=u[pt];q>=Et.y&&q<=Ht.y&&(ft=Rn(Et.x,Ht.x,(q-Et.y)/(Ht.y-Et.y)))}p.setZ(V,Math.sqrt(Math.max(0,ft*ft-p.getX(V)**2))*.76+.1)}m.computeVertexNormals(),r(e,m,M,0,15,0).castShadow=!1,o(t,0,-1,-.3,23,8,16,3,"pants");let y={x:20,y:18.5,z:17},w=14;a(n,0,w,0,y.x,y.y,y.z,"skin");for(let V of[-1,1])a(n,V*19,12,-.8,3.5,4.5,2.7,"skin"),a(n,V*20,12,1.2,1.6,2.6,.55,"ear");a(n,0,8.8,16.2,2.15,1.7,1.5,"skin");function x(V){let q=document.createElement("canvas");q.width=q.height=256,V(q.getContext("2d"));let ft=new bn(q);return ft.colorSpace=we,new je({map:ft,transparent:!0,depthWrite:!1,toneMapped:!1})}function E(V,q,ft,pt,Et,Ht){let Jt=new En(ft,pt,20,16),Ot=Jt.attributes.position;for(let I=0;I<Ot.count;I++){let pe=Ot.getX(I)+V,Yt=Ot.getY(I)+q-w;Ot.setZ(I,y.z*Math.sqrt(Math.max(.001,1-(pe/y.x)**2-(Yt/y.y)**2))+.065)}Jt.computeVertexNormals();let Zt=r(n,Jt,Et,V,q,0);return Zt.name=Ht,Zt.castShadow=!1,Zt.renderOrder=2,Zt}let T=x(V=>{let q=V.createRadialGradient(128,128,8,128,128,120);q.addColorStop(0,"rgba(232,117,112,.62)"),q.addColorStop(.48,"rgba(232,117,112,.30)"),q.addColorStop(1,"rgba(232,117,112,0)"),V.fillStyle=q,V.fillRect(0,0,256,256)});for(let V of[-1,1])E(V*11.4,7.7,11,8.2,T,"blush");function b(V){return x(q=>{if(q.lineCap="round",V<.1){q.strokeStyle="#50372d",q.lineWidth=11,q.beginPath(),q.moveTo(53,136),q.quadraticCurveTo(128,175,203,130),q.stroke();return}q.save(),q.translate(128,133),q.scale(1,V),q.translate(-128,-133),q.fillStyle="#fff1dc",q.beginPath(),q.ellipse(128,133,82,92,0,0,Math.PI*2),q.fill(),q.fillStyle="#634030",q.beginPath(),q.ellipse(130,138,69,83,0,0,Math.PI*2),q.fill(),q.fillStyle="#39291f",q.beginPath(),q.ellipse(131,130,53,67,0,0,Math.PI*2),q.fill(),q.fillStyle="#a16b43",q.beginPath(),q.ellipse(132,191,30,10,0,0,Math.PI*2),q.fill(),q.fillStyle="#fff9eb",q.beginPath(),q.ellipse(104,99,15,18,-.25,0,Math.PI*2),q.fill(),q.globalAlpha=.78,q.beginPath(),q.arc(156,153,7,0,Math.PI*2),q.fill(),q.globalAlpha=1,q.strokeStyle="#50372d",q.lineWidth=9,q.beginPath(),q.moveTo(50,104),q.bezierCurveTo(65,39,175,24,207,102),q.stroke(),q.restore()})}let g=[b(1),b(.5),b(0)],A=[],P=x(V=>{V.strokeStyle="#674436",V.lineCap="round",V.lineWidth=30,V.beginPath(),V.moveTo(43,158),V.quadraticCurveTo(120,81,211,139),V.stroke()});for(let V of[-1,1])A.push({eye:E(V*7.6,13.3,10.8,11.8,g[0],V<0?"left-eye":"right-eye")}),E(V*7.8,21,8,2.7,P,"eyebrow");let U=x(V=>{V.strokeStyle="#995d50",V.lineWidth=13,V.lineCap="round",V.beginPath(),V.moveTo(58,99),V.bezierCurveTo(93,153,161,155,199,98),V.stroke()}),O=x(V=>{V.fillStyle="#965649",V.beginPath(),V.ellipse(128,132,44,45,0,0,Math.PI*2),V.fill(),V.fillStyle="#e7a196",V.beginPath(),V.ellipse(128,153,29,15,0,0,Math.PI*2),V.fill()}),X=E(0,3.8,7,4.3,U,"smile"),L=l(n,0,0,0,"hair"),z=[],$=[],K=24,st=56;for(let V=0;V<=K;V++)for(let q=0;q<=st;q++){let ft=q/st*Math.PI*2,pt=(Math.cos(ft)+1)/2,Et=V/K*Rn(2.14,1.28,pt);z.push(21.1*Math.sin(Et)*Math.sin(ft),16+20*Math.cos(Et),18.5*Math.sin(Et)*Math.cos(ft)-.8)}for(let V=0;V<K;V++)for(let q=0;q<st;q++){let ft=V*(st+1)+q,pt=ft+st+1;$.push(ft,pt,ft+1,pt,pt+1,ft+1)}let Z=new ne;Z.setAttribute("position",new Wt(z,3)),Z.setIndex($),Z.computeVertexNormals(),r(L,Z,"hair",0,0,0);function nt(V,q,ft){let pt=new ui(V.map(R=>new C(...R))),Et=[],Ht=[],Jt=24,Ot=16,Zt=new C,I=new C,pe=new C(0,0,1);for(let R=0;R<=Jt;R++){let v=R/Jt,B=pt.getPoint(v);pt.getTangent(v,Zt),I.crossVectors(Zt,pe).normalize();let H=Math.max(.035,Math.sin(Math.PI*(.1+v*.9))**.55);for(let J=0;J<Ot;J++){let ct=J/Ot*Math.PI*2;Et.push(B.x+I.x*Math.cos(ct)*q*H,B.y+I.y*Math.cos(ct)*q*H,B.z+Math.sin(ct)*ft*H)}}for(let R=0;R<Jt;R++)for(let v=0;v<Ot;v++){let B=R*Ot+v,H=R*Ot+(v+1)%Ot;Ht.push(B,B+Ot,H,H,B+Ot,H+Ot)}let Yt=new ne;Yt.setAttribute("position",new Wt(Et,3)),Yt.setIndex(Ht),Yt.computeVertexNormals(),r(L,Yt,"lock",0,0,0)}nt([[10,32,7],[2,30,15],[-9,25,17],[-16,19,11]],6.5,3),nt([[11,31,7],[15,28,12],[17,22,11],[17,18,7]],5,2.7),nt([[-10,29,9],[-17,23,10],[-19,16,5],[-18,13,2]],3.8,2.2),nt([[2,34,0],[-1,37,1],[-6,37,1]],2.6,1.5);function F(V,q,ft,pt,Et=1){let Ht=new Li,Jt=new Li;V.add(Ht),Ht.add(Jt),Jt.position.y=-ft;let Ot=new Ms(f(q),24),Zt=Ot.attributes.position,I=[],pe=[];for(let R=0;R<Zt.count;R++){Zt.setZ(R,Zt.getZ(R)*Et);let v=be.smoothstep(-Zt.getY(R),ft-4,ft+4);I.push(0,1,0,0),pe.push(1-v,v,0,0)}Ot.setAttribute("skinIndex",new Pi(I,4)),Ot.setAttribute("skinWeight",new Wt(pe,4)),Ot.computeVertexNormals();let Yt=new rr(Ot,s[pt]);return Yt.castShadow=!0,V.add(Yt),i.updateMatrixWorld(!0),Yt.bind(new ar([Ht,Jt])),Jt}let at=[],et=[];for(let V of[-1,1]){let q=l(t,V*7,-1,0,V<0?"left-hip":"right-hip"),ft=F(q,[[-23,0],[-23,4.4],[-19,4.6],[-12,5.1],[-5,5.6],[1,5.4],[3,0]],12,"pants",1.08);ft.name="knee";let pt=l(ft,0,-11.5,0,"ankle");a(pt,0,-.7,2,5.6,3,7.5,"shoe"),o(pt,0,-2.8,2,10.4,1.4,14,.6,"sole");for(let Ot of[2,4])c(pt,[[-1.8,1.6,Ot],[1.8,1.6,Ot]],.22,"white");at.push({thigh:q,knee:ft,ankle:pt});let Et=l(e,V*16,22,0,V<0?"left-shoulder":"right-shoulder"),Ht=F(Et,[[-21,0],[-21,4.3],[-17,5],[-10,5.8],[-3,6],[1,5],[4,0]],11,"sweater",1.05);Ht.name="elbow",d(Ht,-9.4,4.3,.8,1.04);let Jt=l(Ht,0,-12.4,0,"hand");a(Jt,0,-1.5,.2,3.6,4.1,2.9,"skin"),a(Jt,-V*2.5,-.2,1.2,1.45,2.2,1.5,"skin"),et.push({shoulder:Et,elbow:Ht,hand:Jt})}let Tt,ot=0,wt=0,k=0,j=!0,_t=0,Bt=0,yt=new C,kt=new C;function ye(V,q=0,ft=V.t){let{t:pt,player:Et,orb:Ht}=V,Jt=Tt===void 0?1/60:pt-Tt,Ot=Tt===void 0||Jt<0||Jt>.25,Zt=Ot?1/60:Si(Jt,0,.05);Tt=pt;let I=(lt,At,Dt=12)=>Rn(lt,At,1-Math.exp(-Dt*Zt)),pe=(lt,At,Dt)=>lt+gd(At-lt)*(1-Math.exp(-Dt*Zt)),Yt=Math.abs(Et.vx||0),R=!!Et.ground,v=!!V.cinema?.stage||q>.01;Ot&&(j=R,_t=0,k=R?0:1),R&&!j&&(_t=1),j=R,_t*=Math.exp(-11*Zt),wt=I(wt,R&&!Et.rope?Si(Yt/320,0,1):0,9),k=I(k,!R&&!Et.rope&&!q?1:0,13),ot+=Zt*Yt*.062,Bt=I(Bt,v?1:0,6);let B=(37+Math.sin(ft*1.45)*5+Math.sin(ft*.73)*2)*q;i.position.set(Et.x+19,900-Et.y-62+B,25),i.visible=!(Et.invincible>0&&Math.sin(pt*24)<-.5);let H=Si((Et.squash||0)*.45,-.1,.1);i.scale.set(1+H,1-H,1+H*.4),i.rotation.z=(Math.sin(ft*.95)*.028-.015)*q,yt.set(Ht.x,900-Ht.y,Ht.z??55);let J=(Et.face||1)*1.12,ct=Math.atan2(yt.x-i.position.x,yt.z-i.position.z),mt=J+gd(ct-J)*Bt;i.rotation.y=Ot?mt:pe(i.rotation.y,mt,v?5:11);let tt=(.9-Math.cos(ot*2)*.9)*wt;t.position.y=28+tt-_t*2.1+Math.sin(pt*2)*.22*(1-wt),e.rotation.x=I(e.rotation.x,.13*wt-.09*k+.018*Math.sin(pt*2)),e.rotation.z=I(e.rotation.z,Math.sin(ot)*.045*wt),e.rotation.y=I(e.rotation.y,Math.sin(ot)*.075*wt),at.forEach(({thigh:lt,knee:At,ankle:Dt},Vt)=>{let D=ot+Vt*Math.PI,gt=Math.sin(D),Q=Math.max(0,Math.cos(D)),ht=-gt*.78*wt,dt=(.13+Q*.95)*wt+_t*.28,rt=-ht-dt*.7,Ut=Si(-(Et.vy||0)/500,0,1),Pt=Si((Et.vy||0)/650,0,1);ht=Rn(ht,Vt===0?-.55-.3*Ut:.18+.24*Pt,k),dt=Rn(dt,Vt===0?.65+.35*Ut:.9-.65*Pt,k),rt=Rn(rt,-.2,k),ht=Rn(ht,Vt===0?-.16:.12,q),dt=Rn(dt,.18,q),Et.rope&&(ht=Vt===0?-.6:.12,dt=Vt===0?1:.45,rt=-.1),lt.rotation.x=I(lt.rotation.x,ht,18),At.rotation.x=I(At.rotation.x,dt,18),Dt.rotation.x=I(Dt.rotation.x,rt,18)}),et.forEach(({shoulder:lt,elbow:At,hand:Dt},Vt)=>{let D=Vt===0?-1:1,gt=ot+Vt*Math.PI,Q=Math.sin(gt)*.65*wt-.04,ht=-.2-.7*wt,dt=D*(.07+k*.22);Q=Rn(Q,-.55+Si((Et.vy||0)/800,-.4,.5),k),ht=Rn(ht,-.65,k),Q=Rn(Q,-.1+Math.sin(ft*1.2+Vt)*.035,q),dt+=D*.1*q,Et.rope&&(Q=-2.8,dt=D*.12,ht=-.2),Et.wall&&!R&&!Et.rope&&(Q=-1.35,ht=-.45),lt.rotation.x=I(lt.rotation.x,Q),lt.rotation.z=I(lt.rotation.z,dt),At.rotation.x=I(At.rotation.x,ht),Dt.rotation.z=Math.sin(pt*2+Vt)*.035}),i.updateMatrixWorld(!0),kt.copy(yt),e.worldToLocal(kt),kt.sub(n.position);let it=Si(Math.atan2(kt.x,kt.z),-.95,.95)*Bt,xt=Si(-Math.atan2(kt.y-13,Math.hypot(kt.x,kt.z)),-.65,.55)*Bt;n.rotation.y=pe(n.rotation.y,it,14),n.rotation.x=I(n.rotation.x,xt-.035*wt,12),n.rotation.z=I(n.rotation.z,Math.sin(pt*1.8)*.018*(1-wt),8);let Nt=pt%4.7,vt=Math.max(0,1-Math.abs(Nt-4.35)/.1);for(let{eye:lt}of A)lt.material=g[vt>.8?2:vt>.3?1:0];X.material=V.speaker==="VOS"&&Math.sin(pt*13)>-.2?O:U,L.rotation.x=I(L.rotation.x,-.025*wt*Math.sin(ot)-.025*k,9)}return{root:i,hips:t,torso:e,head:n,legs:at,arms:et,eyes:A,update:ye}}var ve=i=>{let t=Math.sin(i*127.1+311.7)*43758.5453;return t-Math.floor(t)};function xd(i,t){let e=new te,n=new te;n.applyMatrix4(t),e.add(n);let s=i.x*.17+i.y*.31,r=115,a=Math.min(225,65+i.w*.095),o=Math.max(3,Math.ceil(i.w/65)),l=[];for(let F=0;F<=o;F++)l.push([i.w*F/o,0]);l.push([i.w,-r*.5]);for(let F=o;F>=0;F--)l.push([i.w*F/o,-r]);l.push([0,-r*.5]);let c=[0,1,2,3].map(F=>l.map(([at,et],Tt)=>{let ot=[1,1,.87,.58][F];return[i.w/2+(at-i.w/2)*ot,F===0?0:F===1?-12-ve(s+Tt)*9:F===2?-a*(.42+ve(s+Tt)*.19):-a*(.75+ve(s+Tt*3)*.35),-r/2+(et+r/2)*ot]})),h=[],f=[],u=new Gt;function d(F,at,et,Tt,ot=1){u.set(Tt).multiplyScalar(ot);for(let wt of[F,at,et])h.push(...wt),f.push(u.r,u.g,u.b)}let _=i.kind==="crumble"?[5665594,8937543,4798767]:[5405753,7753785,4207404];for(let F=0;F<l.length;F++){let at=(F+1)%l.length;d([i.w/2,0,-r/2],c[0][at],c[0][F],5537595,.85+ve(s+F)*.3);for(let et=0;et<3;et++)d(c[et][F],c[et][at],c[et+1][F],_[et],.8+ve(s+F+et)*.4),d(c[et][at],c[et+1][at],c[et+1][F],_[et],.8+ve(s+F*2+et)*.4);d(c[3][F],c[3][at],[i.w/2,-a*.9,-r/2],3484710)}let M=new ne;M.setAttribute("position",new Wt(h,3)),M.setAttribute("color",new Wt(f,3)),M.computeVertexNormals();let m=new se(M,new Fe({vertexColors:!0,roughness:1,side:Ye}));m.castShadow=!0,m.receiveShadow=!0,n.add(m);let p=[];for(let F=0;F<Math.ceil(i.w/85);F++){let at=15+ve(s+F*9)*Math.max(1,i.w-30),et=-a*(.55+ve(s+F)*.25),Tt=-12-ve(s+F*4)*65,ot=[at-8+ve(s+F*8)*16,et-22-ve(s+F*6)*38,Tt];p.push(at,et,Tt,...ot,...ot,ot[0]+10,ot[1]-13,Tt-4)}n.add(new li(new ne().setAttribute("position",new Wt(p,3)),new Kn({color:5850674})));let y=[],w=[],x=[],E=[],T=Math.ceil(i.w*1.5);for(let F=0;F<T;F++){let at=2+ve(s+F*3.13)*Math.max(1,i.w-4),et=32+ve(s+F*7.7)*12,Tt=10+ve(s+F*4.6)*19,ot=1.1+ve(s+F*8.2)*1.8,wt=-ve(s+F*1.7)*8,k=[[at-ot,0,et],[at+ot,0,et],[at+wt+ot*.4,Tt*.55,et],[at-ot,0,et],[at+wt+ot*.4,Tt*.55,et],[at+wt-ot*.4,Tt*.55,et],[at+wt-ot*.4,Tt*.55,et],[at+wt+ot*.4,Tt*.55,et],[at+wt*1.6,Tt,et]],j=ve(s+F*2.9);for(let _t of k)y.push(..._t),x.push(at,et),E.push(_t[1]/Tt),u.setHSL(.22+j*.065,.38+j*.2,.24+j*.12+_t[1]/Tt*.13),w.push(u.r,u.g,u.b)}let b=new ne;b.setAttribute("position",new Wt(y,3)),b.setAttribute("color",new Wt(w,3)),b.setAttribute("anchor",new Wt(x,2)),b.setAttribute("weight",new Wt(E,1)),b.computeVertexNormals();let g={windTime:{value:0},heroLocal:{value:new ut(-1e4,1e4)},heroSpeed:{value:0},islandX:{value:i.x}},A=new Fe({vertexColors:!0,side:Ye,roughness:1});A.onBeforeCompile=F=>{Object.assign(F.uniforms,g),F.vertexShader=`attribute vec2 anchor; attribute float weight; uniform float windTime; uniform vec2 heroLocal; uniform float heroSpeed; uniform float islandX;
`+Hc+`
